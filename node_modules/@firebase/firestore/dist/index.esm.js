...
import { XhrIo as d, EventType as y, ErrorCode as v, createWebChannelTransport as g, WebChannel as m } from "@firebase/webchannel-wrapper";
...
function E(t) {
    ...
    if (b.logLevel <= s.DEBUG) {
        var i = e.map(_);
        b.debug.apply(b, r([ "Firestore (7.19.0): " + t ], i));
    }
}
...
function T(t) {
    ...
    if (b.logLevel <= s.ERROR) {
        var i = e.map(_);
        b.error.apply(b, r([ "Firestore (7.19.0): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (b.logLevel <= s.WARN) {
        var i = e.map(_);
        b.warn.apply(b, r([ "Firestore (7.19.0): " + t ], i));
    }
}
 ...
 */ var M = /** @class */ function() {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new G(F.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new G(F.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new G(F.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new G(F.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    n.k = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new G(F.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(z), W = /^[_a-zA-Z][_a-zA-Z0-9]*$/, H = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.g = function(t, e, r) {
    ...
    n.q = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new G(F.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new G(F.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new G(F.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new G(F.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.$ = function() {
        return new n([]);
    }, n;
...
function nt(t) {
    return K.j(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
 ...
 */ function ct(t) {
    ...
    return T("GRPC error has no .code"), F.UNKNOWN;
    switch (t) {
      case it.OK:
        return F.OK;
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.ke = function(t) {
        ...
        return this.Ae = vt(), this.Re = Vt(), this.Pe = new pt(L), i;
    }, 
    /**
    ...
    t.prototype.we = function(t) {
        ...
        var e = this.Re.get(t);
        return e || (e = new pt(L), this.Re = this.Re.st(t, e)), e;
    }, 
    /**
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Gt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return P(t.arrayValue.values || [], e.arrayValue.values || [], Gt);
...
function Qt(t) {
    return function t(e) {
        ...
        K.U(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function de(t, e) {
    var n = le(e);
    return S(n.get(1) === t.s.projectId), S(!n.get(3) && !t.s.database || n.get(3) === t.s.database), 
    new K(me(n));
}
...
function ve(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? Q.$() : me(e);
}

function ge(t) {
    return new Q([ "projects", t.s.projectId, "databases", t.s.database ]).F();
}

function me(t) {
    return S(t.length > 4 && "documents" === t.get(4)), t.V(5)
...
function Ie(t, e) {
    ...
    if (e.transform) {
        var u = de(t, e.transform.document), a = e.transform.fieldTransforms.map((function(e) {
            return function(t, e) {
                var n = null;
                if ("setToServerValue" in e) S("REQUEST_TIME" === e.setToServerValue), n = new Ue; else if ("appendMissingElements" in e) {
                    var r = e.appendMissingElements.values || [];
                    n = new Ce(r);
                } else if ("removeAllFromArray" in e) {
                    var i = e.removeAllFromArray.values || [];
                    n = new Me(i);
                } else "increment" in e ? n = new Ge(t, e.increment) : A();
                var o = H.q(e.fieldPath);
                return new Qe(o, n);
            }(t, e);
        }));
        return S(!0 === n.exists), new on(u, a);
    }
    if (e.verify) {
        var c = de(t, e.verify);
        return new cn(c, n);
 ...
 */ function Ze(t, e, n) {
    return t instanceof en ? function(t, e, n) {
        ...
        if (S(null != n.transformResults), !Ke(t.Qe, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
...
function Je(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Qe.isEqual(e.Qe) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || P(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof Ce && e instanceof Ce || t instanceof Me && e instanceof Me ? P(t.elements, e.elements, Gt) : t instanceof Ge && e instanceof Ge ? Gt(t.Be, e.Be) : t instanceof Ue && e instanceof Ue;
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (!(t instanceof e)) throw e.name === t.constructor.name ? new G(F.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass '" + e.name + "' from a different Firestore SDK?") : new G(F.INVALID_ARGUMENT, "Expected type '" + e.name + "', but was '" + t.constructor.name + "'");
    return t;
}
 ...
 */ var mn = /** @class */ function() {
     ...
     */    return t.prototype.on = function(e) {
        ...
        return !Y(this.limit) && "F" /* First */ === this.nn;
    }, t.prototype.cn = function() {
        return !Y(this.limit) && "L" /* Last */ === this.nn;
 ...
 */ function En(t) {
    ...
    if (null === e.sn) {
        ...
        n.M() || e.sn.push(new Qn(n)), e.sn.push(new Qn(H.L(), "asc" /* ASCENDING */)); else {
 ...
 */ function Tn(t) {
    var e = gn(t, mn);
    if (!e.rn) if ("F" /* First */ === e.nn) e.rn = J(e.path, e.collectionGroup, En(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.rn = J(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.rn;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function xn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.W(t.collectionGroup) && t.path.D(n) : K.j(t.path) ? t.path.isEqual(n) : t.path.C(n);
    }(t, e) && function(t, e) {
...
var Pn = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        if ($t(r)) {
            ...
            throw new G(F.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (Jt(r)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new G(F.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
...
var Rn = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = K.U(r.referenceValue), i;
    }
 ...
 */ function Bn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.M() ? K.P(K.U(s.referenceValue), n.key) : Bt(s, n.field(o.field)), 
...
function Wn(t, e, n) {
    var r = t.field.M() ? K.P(e.key, n.key) : function(t, e, n) {
 ...
 */ var Kn = /** @class */ function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.pn && A(), this.pn = !0, this.yn ? this.error ? this.bn(n, this.error) : this.vn(e, this.result) : new t((function(t, i) {
            r.gn = function(n) {
                r.vn(e, n).next(t, i);
            }, r.Vn = function(e) {
                r.bn(n, e).next(t, i);
 ...
 */
        ...
        return this.Hn(t, new K(e)).next((function(t) {
            var e = wt();
...
var rr = function() {
    ...
    t.prototype.bs = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && E("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.gs + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.Fs(u()) && T("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return E("SimpleDb", "Removing database:", t), fr(window.indexedDB.deleteDatabase(t)).Sn();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.ks = function() {
        ...
        // Check the UA string to find out the browser.
                var e = u(), n = t.Fs(e), r = 0 < n && n < 10, i = t.xs(e), o = 0 < i && i < 4.5;
        // IE 10
                  ...
                  case 0:
                    ...
                    t = this, [ 4 /*yield*/ , new Promise((function(t, n) {
                        ...
                        r.onsuccess = function(e) {
                            ...
                            "VersionError" === e.name ? n(new G(F.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new ur(e));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, F.UNAVAILABLE, "IndexedDB transaction failed: " + t) || this).name = "IndexedDbTransactionError", 
        n;
    }
    return t(n, e), n;
}(G);
 ...
 */ var cr = /** @class */ function() {
    ...
    return t.open = function(e, n, r) {
        ...
        t && this.zs.reject(t), this.aborted || (E("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
...
function pr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(n) >= 0) {
            ...
            var r = new G("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + n + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return lr || (lr = !0, 
 ...
 */ var vr = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.oi && (this.clearTimeout(), this.ii.reject(new G(F.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Ei = function() {
            var e = yr();
            e && E("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.Ti.Ds();
        };
        var e = yr();
    ...
    t.prototype.Vi = function() {
        ...
        var e = this, n = this.ci.then((function() {
            return e.di = !0, t().catch((function(t) {
                ...
                throw e.fi = t, e.di = !1, T("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
function mr(t, e) {
    if (T("AsyncQueue", e + ": " + t), ar(t)) return new G(F.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var Tr = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        E("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.Xi = this.ei.Ss("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
    ...
    t.prototype.ar = function(t, e) {
        ...
        var n = this;
        return this.params.Li === Er.ji ? (E("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Zn.resolve(Ir)) : this.ur(t).next((function(r) {
            return r < n.params.Li ? (E("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.Li), 
            Ir) : n.lr(t, e);
        }));
        ...
        return this.sr(t, this.params.qi).next((function(e) {
            ...
            return e > h.params.Bi ? (E("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + h.params.Bi + " from " + e), 
 ...
 */ function Dr(t) {
    ...
    var e = t.length;
    if (S(e >= 2), 2 === e) return S("" === t.charAt(0) && "" === t.charAt(1)), Q.$();
...
/** Decodes a remote document from storage locally to a Document. */ function xr(t, e) {
    ...
    if (e.noDocument) {
        var n = K.K(e.noDocument.path), r = Vr(e.noDocument.readTime);
        return new yn(n, r, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        var i = K.K(e.unknownDocument.path), o = Vr(e.unknownDocument.version);
        return new vn(i, o);
    }
    return A();
}
...
/** Decodes a DbTarget into TargetData */ function Cr(t) {
    ...
    return void 0 !== t.query.documents ? (S(1 === (n = t.query).documents.length), 
    e = Tn(bn(ve(n.documents[0])))) : e = function(t) {
        ...
        n.limit && (a = function(t) {
            var e;
            return Y(e = "object" == typeof t ? t.value : t) ? null : e;
        }(n.limit));
        var c = null;
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var Mr = /** @class */ function() {
    ...
    return t.Tr = function(e, n, r, i) {
        ...
        return S("" !== e.uid), new t(e.Er() ? e.uid : "", n, r, i);
        ...
        return jr(t).get(e).next((function(t) {
            return t ? (S(t.userId === n.userId), Ur(n.serializer, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Pr = function(t, e) {
        ...
        return jr(t).Zs({
            ...
            e.userId === n.userId && (S(e.batchId >= r), o = Ur(n.serializer, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        // the given documentKey.
            ...
            return jr(t).get(c).next((function(t) {
                if (!t) throw A();
                S(t.userId === n.userId), o.push(Ur(n.serializer, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = e.path, i = r.length + 1, o = ri.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new pt(L);
        return Br(t).Zs({
            range: s
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(jr(t).get(e).next((function(t) {
                if (null === t) throw A();
                S(t.userId === n.userId), r.push(Ur(n.serializer, t));
            })));
        })), Zn.Cn(i).next((function() {
            return r;
        }));
 ...
 */ var Qr = /** @class */ function() {
    ...
    t.prototype.Lr = function(t, e) {
        ...
        return Hr(t).Zs({
            ...
            for (var s = K.K(t); o && K.P(o, s) < 0; ) n(o, null), o = i.wt();
            o && o.isEqual(s) && (
            // Key found in cache.
 ...
 */ Qr.Kr = /** @class */ function(e) {
    ...
    function n(t, n) {
        ...
        r.Yr = new M((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    }
    return t(n, e), n.prototype.Un = function(t) {
...
var Zr = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        return (this.index[t] || new pt(Q.P)).N();
    }, t;
}(), $r = /** @class */ function() {
    function t(t) {
        this.serializer = t;
 ...
 */ var gi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.fo(t, e.targetId).next((function() {
            ...
            return S(e.targetCount > 0), e.targetCount -= 1, n.io(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.uo = function(t, e) {
        ...
        return r.Zs({
            ...
            var r = Dr(t[1]), o = new K(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.Nr = function(t, e) {
        var n = _r(e.path), r = IDBKeyRange.bound([ n ], [ R(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ii(t).Zs({
 ...
 */ var Ei = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ti = /** @class */ function(e) {
    ...
    h) {
        ...
        }, !t.ks()) throw new G(F.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    ...
    t.prototype.start = function() {
        ...
        // do.
            ...
            throw new G(F.FAILED_PRECONDITION, Ei);
    ...
    t.prototype.lh = function(t) {
        var e = this;
        return _i(t).get(ti.key).next((function(t) {
            if (null !== t && e.Yo(t.leaseTimestampMs, 5e3) && !e.Zo(t.ownerId) && !e.Go(t) && !(e.Vo || e.allowTabSynchronization && t.allowTabSynchronization)) throw new G(F.FAILED_PRECONDITION, Ei);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.jo = function(t) {
        ...
        return n.get(ti.key).next((function(t) {
            return e.Go(t) ? (E("IndexedDbPersistence", "Releasing primary lease."), n.delete(ti.key)) : Zn.resolve();
        }));
    }, 
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                s = s.next((function() {
                    ...
                    S(null !== s), (!o || o.version.o(s) < 0) && ((o = i.En(t, o, n)) && 
 ...
 */ function Ri(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return S(e.resumeToken.Y() > 0), 0 === t.resumeToken.Y() || (
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Kt.forEach((function(a, c) {
                ...
                u = u.st(a, c)) : E("LocalStore", "Ignoring outdated watch update for ", a, ". Current version:", h.version, " Watch version:", c.version), 
...
function Ui(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = D(t), o = e.Eh.get(r), s = i ? "readwrite" : "readwrite-primary", n.label = 1;
              ...
              case 4:
                ...
                // don't define exact LRU semantics so this is acceptable.
                                return E("LocalStore", "Failed to update sequence numbers for target " + r + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function Ci(t, e, n) {
    var r = D(t), i = B.min(), o = Et();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = D(t), i = r.mh.get(n);
...
// PORTING NOTE: Multi-Tab only.
function qi(t, e) {
    var n = D(t), r = D(n.ko), i = n.Eh.get(e);
 ...
 */ function Mi(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== F.FAILED_PRECONDITION || t.message !== $n) throw t;
 ...
 */ var Fi = /** @class */ function() {
    ...
    t.prototype.Ch = function(t) {
        var e = this, n = new K(new Q([])), r = new Gi(n, t), i = new Gi(n, t + 1), o = [];
        ...
        var e = new K(new Q([])), n = new Gi(e, t), r = new Gi(e, t + 1), i = Et();
    ...
    return t.yh = function(t, e) {
        return K.P(t.key, e.key) || L(t.kh, e.kh);
    }, 
    /** Compare by ID then by key */ t.bh = function(t, e) {
        return L(t.kh, e.kh) || K.P(t.key, e.key);
    }, t;
}(), ji = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
var Bi = function(t, e) {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.jh !== e ? (E("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (S("string" == typeof n.accessToken), new Bi(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.Kh = function() {
        ...
        return S(null === t || "string" == typeof t), new ji(t);
    }, t;
}(), Wi = /** @class */ function() {
    function t(t, e) {
    ...
    t.prototype.ca = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new G(F.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.fa(e);
            }));
        }));
    ...
    t.prototype.la = function(t) {
        ...
        return function(n) {
            e.ms.ai((function() {
                return e.Zh === t ? n() : (E("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Le ? (S(void 0 === e || "string" == typeof e), rt.fromBase64String(e || "")) : (S(void 0 === e || e instanceof Uint8Array), 
    ...
    return t(n, e), Object.defineProperty(n.prototype, "Ra", {
        /**
    ...
    n.prototype.start = function() {
        ...
        S(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Aa) {
        ...
        // The first response is always the handshake response
                return S(!t.writeResults || 0 === t.writeResults.length), this.Aa = !0, 
        this.listener.Va();
    }, 
    /**
    ...
    return t(n, e), n.prototype.ba = function() {
        if (this.pa) throw new G(F.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.va = function(t, e, n) {
        ...
        return this.ba(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === F.UNAUTHENTICATED && r.credentials.qh(), t;
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Fa ? (T(e), this.Fa = !1) : E("OnlineStateTracker", e);
            ...
            i.ai((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Ga() ? (E("RemoteStore", "Restarting streams for network reachability change."), 
    ...
    t.prototype.disableNetwork = function() {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.Ba.length > 0 && (E("RemoteStore", "Stopping write stream with " + this.Ba.length + " pending writes"), 
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return E("RemoteStore", "RemoteStore shutting down."), this.Wa.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.ac() ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 11:
                    return E("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.wc(o) ];
    ...
    t.prototype.Rc = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return at(r = t.code) && r !== F.ABORTED ? (e = this.Ba.shift(), 
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    E("RemoteStore", "RemoteStore received new credentials"), this.Wa.add(3 /* CredentialChange */), 
                    [ 4 /*yield*/ , this.ac() ];
...
var ro = /** @class */ function() {
    ...
    return t.Dc = function(e, n, r) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (s = new G(i.error.code, i.error.message))), 
    ...
    return t.Dc = function(e, n) {
        ...
        return i && r.error && ((i = "string" == typeof r.error.message && "string" == typeof r.error.code) && (o = new G(r.error.code, r.error.message))), 
    ...
    return t.Dc = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Nt(), s = 0; i && s < r.activeTargetIds.length; ++s) i = X(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.Da = null, this.fs = null, this.$c = this.xc.bind(this), this.Oc = new ht(L), 
        this.tr = !1, 
        /**
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.ks = function(t) {
        ...
        // `Window.addEventListener`.
            ...
            if (E("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Lc) return void T("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.ms.gi((function() {
                return e(r, void 0, void 0, (function() {
                    var t, e, r, o, s, u;
                    return n(this, (function(n) {
    ...
    t.prototype.Kc = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.fc.mu(t.batchId, t.state, t.error) ] : (E("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    }, t.prototype.Eu = function(t) {
...
n) {
    ...
    r, i, o) {
        ...
        this.Wu = null, this.ju = new M((function(t) {
            return Dn(t);
        }), Sn), this.Ku = new Map, 
        /**
    ...
    t.prototype.sl = function(t, r, i) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    ...
                    function(t, e) {
                        var n, r = D(t), i = j.now(), o = e.reduce((function(t, e) {
                            return t.add(e.key);
                        }), Et());
                ...
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    t.Wt.forEach((function(t, e) {
                        ...
                        S(t.Jt.size + t.Xt.size + t.Zt.size <= 1), t.Jt.size > 0 ? n.qu = !0 : t.Xt.size > 0 ? S(n.qu) : t.Zt.size > 0 && (S(n.qu), 
                        n.qu = !1));
                    })), [ 4 /*yield*/ , this.hl(e, t) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Uu.ou(t, "rejected", r), e = this.Hu.get(t), (i = e && e.key) ? (o = (o = new ht(K.P)).st(i, new yn(i, B.min())), 
                    s = Et().add(i), u = new Dt(B.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new pt(L), o, s), [ 4 /*yield*/ , this.mc(u) ]) : [ 3 /*break*/ , 2 ];
                    ...
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                        ...
                        return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                            ...
                            return n.Gn.Rr(t, e).next((function(e) {
                                return S(null !== e), r = e.keys(), n.Gn.br(t, e);
                            })).next((function() {
                                return n.Gn.Cr(t);
                            })).next((function() {
                                return n.Rh.Zn(t, r);
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Bu.Ga() || E("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.fl = function(t) {
        this.Xu.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new G(F.CANCELLED, t));
            }));
        })), this.Xu.clear();
    }, t.prototype.ol = function(t, e) {
        var n = this.Ju[this.currentUser.$h()];
        n || (n = new ht(L)), n = n.st(t, e), this.Ju[this.currentUser.$h()] = n;
    }, 
    /**
    ...
    t.prototype.ul = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof ho ? (this.Yu.Eo(i.key, t), this.Tl(i)) : i instanceof fo ? (E("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.zu.get(e) || (E("SyncEngine", "New document in limbo: " + e), this.Gu.push(e), 
        this.cl());
    }, 
    /**
    ...
    t.prototype.ml = function() {
                                ...
                                switch (n.label) {
                                  ...
                                  case 3:
                                    ...
                                    // would have, but it should not invalidate the integrity of the data.
                                                                        return E("LocalStore", "Failed to update sequence numbers: " + i), 
                                    [ 3 /*break*/ , 4 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (E("SyncEngine", "User change. New user:", t.$h()), 
                    [ 4 /*yield*/ , 
                    /**
                    ...
                    function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = D(t), i = e.Gn, o = e.Rh, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
...
function go(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Ci((e = D(t)).La, r.query, 
                /* usePreviousResults= */ !0) ];
...
function mo(t, r, i, o) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return (e = D(t)).nl("applyBatchState()"), [ 4 /*yield*/ , function(t, e) {
                    var n = D(t), r = D(n.Gn);
...
function wo(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = D(t), !0 !== r || !0 === e.tl ? [ 3 /*break*/ , 3 ] : (i = e.Uu.zc(), 
                [ 4 /*yield*/ , bo(e, i.N()) ]);
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Hu.forEach((function(t, n) {
                        e.Bu.lc(n);
                    })), e.Yu.Nh(), e.Hu = new Map, e.zu = new ht(K.P);
...
function Eo(t) {
    var e = D(t);
    return D(D(e.La).persistence).rh();
}
...
/** Adds or removes Watch targets for queries from different tabs. */ function No(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(d) {
            switch (d.label) {
              case 0:
                if (!(e = D(t)).tl) return [ 3 /*break*/ , 10 ];
                o = 0, s = r, d.label = 1;

              case 1:
                return o < s.length ? (u = s[o], e.Ku.has(u) ? (
                // A target might have been added in a previous attempt
                E("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , qi(e.La, u) ]) : [ 3 /*break*/ , 6 ];
 ...
 */ var _o = function() {
    ...
    function t(t) {
        this.fc = t, this.gl = new M((function(t) {
            return Dn(t);
    ...
    return t.prototype.Ph = function(t) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var u = i.Ml(e, o);
            return (e.an() || e.cn()) && i.Nu(e.nn, u, r, n) ? i.Ol(t, e) : (I() <= s.DEBUG && E("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), kn(e)), 
    ...
    return t.prototype.mr = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                K.j(i) || (i = i.child(""));
        var o = new Gi(new K(i), 0), s = new pt(L);
        ...
        var n = this;
        S(0 === this.Wl(e.batchId, "removed")), this.Gn.shift();
        var r = this.ql;
...
var Lo = /** @class */ function() {
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.A_ = function(t, e, n, r) {
            ...
            s.listenOnce(y.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case v.TIMEOUT:
                        E("Connection", 'RPC "' + t + '" timed out'), o(new G(F.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case v.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new G(u, r.message));
                            } else o(new G(F.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new G(F.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.T_, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = g(), i = {
        ...
        return v(m.EventType.OPEN, (function() {
            d || E("Connection", "WebChannel transport opened.");
        })), v(m.EventType.CLOSE, (function() {
            d || (d = !0, E("Connection", "WebChannel transport closed"), y.f_());
        })), v(m.EventType.ERROR, (function(t) {
            d || (d = !0, N("Connection", "WebChannel transport errored:", t), y.f_(new G(F.UNAVAILABLE, "The operation could not be completed")));
        })), v(m.EventType.MESSAGE, (function(t) {
            var e;
            if (!d) {
                var n = t.data[0];
                S(!!n);
                ...
                if (i) {
                    ...
                    d = !0, y.f_(new G(u, a)), s.close();
                } else E("Connection", "WebChannel received:", n), y.d_(n);
            }
        })), setTimeout((function() {
 ...
 */ var Go = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", jo = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t.k_.F_) throw new G(F.FAILED_PRECONDITION, Go);
        return new Po(Oo.i_);
        ...
        throw new G(F.FAILED_PRECONDITION, Go);
    }, t;
}(), Bo = /** @class */ function(r) {
    function i(t) {
        var e = this;
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        ...
        if (t.k_.F_ && t.k_.synchronizeTabs) {
            var e = dr();
            if (!ao.ks(e)) throw new G(F.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
                  ...
                  case 1:
                    return i.sent(), [ 4 /*yield*/ , function(t) {
                        return e(this, void 0, void 0, (function() {
                            var e, r;
                            return n(this, (function(n) {
                                return e = D(t), r = D(e.Ah), [ 2 /*return*/ , e.persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                                    return r.Wr(t);
                                })).then((function(t) {
                                    e.Ih = t;
                                })) ];
 ...
 */ function Ho(t, e) {
    if (0 !== e.length) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + fs(e.length, "argument") + ".");
}
 ...
 */ function Ko(t, e, n) {
    if (e.length !== n) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires " + fs(n, "argument") + ", but was called with " + fs(e.length, "argument") + ".");
}
 ...
 */ function Yo(t, e, n) {
    if (e.length < n) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires at least " + fs(n, "argument") + ", but was called with " + fs(e.length, "argument") + ".");
}
 ...
 */ function Zo(t, e, n, r) {
    if (e.length < n || e.length > r) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + fs(e.length, "argument") + ".");
}
...
function es(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = os(r);
        throw new G(F.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function ns(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new G(F.INVALID_ARGUMENT, "Invalid value " + os(r) + " provided to function " + t + "() for its " + hs(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
/** Helper to validate the type of a provided input. */ function rs(t, e, n, r) {
    if (!("object" === e ? is(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = os(r);
        throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function ss(t, e, n) {
    if (void 0 === n) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + hs(e) + " argument, but it was undefined.");
}
 ...
 */ function us(t, e, n) {
    C(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new G(F.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function as(t, e, n, r) {
    var i = os(r);
    return new G(F.INVALID_ARGUMENT, "Function " + t + "() requires its " + hs(n) + " argument to be a " + e + ", but it was: " + i);
}

function cs(t, e, n) {
    if (n <= 0) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires its " + hs(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function ls() {
    if ("undefined" == typeof Uint8Array) throw new G(F.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function ps() {
    if ("undefined" == typeof atob) throw new G(F.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var ds = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new G(F.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new G(F.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + fs(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Xo("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new G(F.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.j_ = new H(t);
}, vs = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.prototype.z_ = function(t) {
...
var Is = /** @class */ function(e) {
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new G(F.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new G(F.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.ef = t, this.nf = e;
    }
     ...
     */
    t.prototype.T = function(t) {
        return L(this.ef, t.ef) || L(this.nf, t.nf);
    }, t;
...
/** Parse document data from a set() call. */ function Vs(t, e, n, r, i, o) {
    ...
    if (o.merge) u = new ze(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            ...
            if (!s.contains(d)) throw new G(F.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Ws(h, d) || h.push(d);
        }
...
/** Parse update data from a list of field/value arguments. */ function Cs(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new G(F.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
...
function Fs(t, e) {
    ...
    e.path && e.path.length > 0 && e.qe.push(e.path) : C(t, (function(t, r) {
        var i = Ms(r, e.uf(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
 ...
 */ function zs(t, e, n) {
    try {
        return function(t) {
            if (t.search(gs) >= 0) throw new G(F.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (vs.bind.apply(vs, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new G(F.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).j_;
    } catch (e) {
...
function Qs(t, e, n, r, i) {
    ...
    a += ")"), new G(F.INVALID_ARGUMENT, (u += ". ") + t + a);
}
 ...
 */ var Hs = /** @class */ function() {
    ...
    return t.prototype.Af = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.Rf(), this.mutations.length > 0) throw new G(F.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = D(t), i = ge(e.serializer) + "/documents", o = {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof yn || t instanceof dn ? i.Pf(t) : A();
                    })), r) ];
                }
            }));
        }));
        ...
        if (n) {
            ...
            throw new G(F.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.gf = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new G(F.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    return t.prototype.run = function() {
        ...
        try {
            ...
            return !Y(e) && e.catch && e.then ? e : (this.ii.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
     ...
     */
    e) {
        this.credentials = t, this.ei = e, this.clientId = x.t(), 
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.Bh((function(t) {
            if (!s) return s = !0, E("FirestoreClient", "Initializing. user=", t.uid), i.Cf(e, n, r, t, o).then(i.Sf.resolve, i.Sf.reject);
            i.ei.gi((function() {
                return i.Bu.vc(t);
            }));
        })), 
    ...
    t.prototype.Df = function() {
        if (this.ei.mi) throw new G(F.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
                                        ...
                                        return e(s, void 0, void 0, (function() {
                                            ...
                                            return n(this, (function(n) {
                                                switch (n.label) {
                                                  ...
                                                  case 1:
                                                    return (t = n.sent()) instanceof dn ? o.resolve(t) : t instanceof yn ? o.resolve(null) : o.reject(new G(F.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];
                    ...
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new rr, o = Zs(t, e, n, {
                            ...
                            next: function(t) {
                                // Remove query first before passing event to user to avoid
                                // user actions affecting the now stale query.
                                o(), t.fromCache && r && "server" === r.source ? i.reject(new G(F.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
var Xs = /** @class */ function() {
    ...
    return t.prototype.Bf = function(t) {
        ...
        var e = Q.k(t);
        S(Le(e));
        var n = new V(e.get(1), e.get(3)), r = new K(e.V(5));
    ...
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new G(F.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        ts("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Er.Gi; else {
            if (t.cacheSizeBytes !== $s && t.cacheSizeBytes < Er.Ki) throw new G(F.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Er.Ki);
    ...
    function t(r, i, o, s) {
        ...
        this.Jf = new gr, this.INTERNAL = {
            ...
            var c = r;
            if (!c.projectId) throw new G(F.INVALID_ARGUMENT, "Must provide projectId");
            this.sf = new V(c.projectId, c.database), 
    ...
    return Object.defineProperty(t.prototype, "rd", {
        ...
        var e = new Js(t);
        if (this.Zf && !this.sd.isEqual(e)) throw new G(F.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.sd = e, void 0 !== e.credentials && (this.nd = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new G(F.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
        ...
        var e, n;
        if (this.Zf) throw new G(F.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new G(F.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.Zf && !this.Zf.Mf) throw new G(F.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        ...
        return new O(this.sf, this.ed, this.sd.host, this.sd.ssl, this.sd.forceLongPolling);
    }, t.prototype.ad = function(t, e, n) {
        var r = this.ld();
        return this.Zf = new Ys(this.nd, this.Jf), this.Zf.start(r, t, e, n);
    }, t.td = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new G(F.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new G(F.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new V(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Yf) throw new G(F.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Yf;
        },
        enumerable: !1,
        configurable: !0
        ...
        this.Xf(), new yu(Q.k(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return Ko("Firestore.doc", arguments, 1), Xo("Firestore.doc", "non-empty string", 1, t), 
        this.Xf(), ru._d(Q.k(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (Ko("Firestore.collectionGroup", arguments, 1), Xo("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new G(F.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.Ed) throw new G(F.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), ru = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n._d = function(t, e, r) {
        if (t.length % 2 != 0) throw new G(F.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.F() + " has " + t.length);
        ...
        !t) throw new G(F.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = Q.k(t);
...
function uu(t, e, n, r, i, o, s) {
    var u;
    if (i.M()) {
        if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new G(F.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
    ...
    return function(t, e) {
        if (e._n()) {
            var n = t.ln();
            if (null !== n && !n.isEqual(e.field)) throw new G(F.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
            var r = t.un();
 ...
 */
        ...
        throw i === e.op ? new G(F.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new G(F.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
    }(t, l), l;
}

function au(t, e, n) {
    if (null !== t.startAt) throw new G(F.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
    if (null !== t.endAt) throw new G(F.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
    var r = new Qn(e, n);
    return function(t, e) {
        if (null === t.un()) {
...
function cu(t, e, n) {
    if ("string" == typeof n) {
        if ("" === n) throw new G(F.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!In(e) && -1 !== n.indexOf("/")) throw new G(F.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(Q.k(n));
        if (!K.j(r)) throw new G(F.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Yt(t, new K(r));
    }
    if (n instanceof ks) return Yt(t, n.if);
    throw new G(F.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + os(n) + ".");
}
 ...
 * array requirements.
 */ function hu(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new G(F.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new G(F.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
    if ("in" /* IN */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) {
        if (t.indexOf(null) >= 0) throw new G(F.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new G(F.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
    }
}

function fu(t, e, n) {
    if (!n.isEqual(e)) throw new G(F.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}

function lu(t) {
    if (t.cn() && 0 === t.en.length) throw new G(F.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var pu = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new G(F.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.Vd = function(t, e, n, i) {
        if (ss(t, 1, e), e instanceof ou) return Ko(t, r([ e ], n), 1), function(t, e, n, r, i) {
            if (!r) throw new G(F.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
            ...
            for (var o = [], s = 0, u = En(t); s < u.length; s++) {
                ...
                if (a.field.M()) o.push(Yt(e, r.key)); else {
                    ...
                    if (Ct(c)) throw new G(F.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.F();
                        throw new G(F.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                    }
                    o.push(c);
                }
            }
        ...
        return function(t, e, n, r, i, o) {
            ...
            var s = t.en;
            if (i.length > s.length) throw new G(F.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
            for (var u = [], a = 0; a < i.length; a++) {
                var c = i[a];
                if (s[a].field.M()) {
                    if ("string" != typeof c) throw new G(F.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                    if (!In(t) && -1 !== c.indexOf("/")) throw new G(F.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(Q.k(c));
                    if (!K.j(h)) throw new G(F.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new K(h);
                    u.push(Yt(e, f));
                } else {
                    var l = qs(n, r, c);
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.pd.Ut) throw new G(F.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, bn(t), n, r) || this).Dd = t, t.length % 2 != 1) throw new G(F.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.F() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new ru(new K(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = x.t()), Xo("CollectionReference.doc", "non-empty string", 1, t);
        var e = Q.k(t);
...
function vu(t, e) {
    ...
    if (us(t, e, [ "merge", "mergeFields" ]), ts(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + os(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new G(F.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + os(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof vs;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new G(F.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function wu(t, e, n) {
    if (e instanceof ks) {
        if (e.firestore !== n) throw new G(F.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
export { Tu as __PRIVATE_registerFirestore };
