...
}(L), S = /^[_a-zA-Z][_a-zA-Z0-9]*$/, P = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.prototype.V = function(t, e, r) {
...
function j(t) {
    return O.j(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
...
var G, z, $ = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = D.min()), void 0 === o && (o = D.min()), void 0 === s && (s = B.J), 
 ...
 *     Code.UNKNOWN.
 */ (z = G || (G = {}))[z.OK = 0] = "OK", z[z.CANCELLED = 1] = "CANCELLED", z[z.UNKNOWN = 2] = "UNKNOWN", 
...
var H = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.P, this.root.st(e, n, this.P).copy(null, null, K.it, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.P, this.root.remove(e, this.P).copy(null, null, K.it, null, null));
    }, 
...
var Z = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Dt = function(t) {
        ...
        return new X(this.data.ut());
    }, t.prototype.ct = function(t) {
        return new X(this.data.ct(t));
    }, 
 ...
 */ var ht = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.P = t ? function(e, n) {
            return t(e, n) || O.P(e.key, n.key);
        } : function(t, e) {
            return O.P(t.key, e.key);
        }, this.$t = it(), this.kt = new H(this.P)
        /**
    ...
    return t.Wt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Ut === t.Ut && this.qt.isEqual(t.qt) && nn(this.query, t.query) && this.docs.isEqual(t.docs) && this.Mt.isEqual(t.Mt))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, dt.Ht(e, n)), new t(D.min(), r, ct(), et(), ut());
    }, t;
}(), dt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = B.J), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.le = function() {
        ...
        })), new dt(this.re, this.oe, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype._e = function() {
        this.he = !1, this.ie = _t();
    ...
    return t.prototype.Ve = function(t) {
        for (var e = 0, n = t.te; e < n.length; e++) {
            var r = n[e];
            t.ee instanceof ze ? this.ye(r, t.ee) : t.ee instanceof $e && this.pe(r, t.key, t.ee);
        }
    ...
    t.prototype.$e = function(t) {
        ...
        this.Ie.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Yt && j(o.target)) {
                    ...
                    null !== e.Re.get(s) || e.ke(i, s) || e.pe(i, s, new $e(s, t));
                }
        ...
        var i = new pt(t, n, this.Pe, this.Re, r);
        return this.Re = et(), this.Ae = bt(), this.Pe = new Z(m), i;
    }, 
    /**
    ...
    t.prototype.we = function(t) {
        ...
        var e = this.Ie.get(t);
        return e || (e = new mt, this.Ie.set(t, e)), e;
    }, t.prototype.Oe = function(t) {
        var e = this.Ae.get(t);
        return e || (e = new Z(m), this.Ae = this.Ae.st(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Ce = function(t) {
        var e = this;
        this.Ie.set(t, new mt), this.Ee.xe(t).forEach((function(n) {
 ...
 */ function It(t) {
    ...
    return new R(e.seconds, e.nanos);
}
...
function Rt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = m(St(t.latitude), St(e.latitude));
            return 0 !== n ? n : m(St(t.longitude), St(e.longitude));
...
function Dt(t, e) {
    ...
    var n = Vt(t), r = Vt(e), i = m(n.seconds, r.seconds);
...
function Lt(t) {
    return function t(e) {
        ...
        O.B(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
/** Returns a reference value for the provided database and key. */ function Ot(t, e) {
    return {
...
function Zt(t, e) {
    ...
    new O((d((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
...
function te(t) {
    return new V([ "projects", t.s.projectId, "databases", t.s.database ]).N();
}
...
function ie(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Xt(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Xt(t, r.g()), n.structuredQuery.from = [ {
        collectionId: r.S()
    } ]);
    var i = function(t) {
        if (0 !== t.length) {
 ...
 */ function he(t, e, n) {
    return t instanceof pe ? function(t, e) {
        ...
        var n = le(t, e), r = we(n) + we(t.Ue);
        return Ut(n) && Ut(t.Ue) ? Gt(r) : zt(t.serializer, r);
    }(t, e);
}
 ...
 */ var me = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).serializer = e, r.Ue = n, r;
    }
    return e.__extends(n, t), n;
}(ce);
 ...
 */ function ke(t, e, n) {
    return t instanceof Se ? function(t, e, n) {
        ...
        if (d(null != n.transformResults), !Ae(t.We, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */ function Re(t, e, n, r) {
    return t instanceof Se ? function(t, e) {
        ...
        return Ae(t.We, e) ? new $e(t.key, D.min()) : e;
    }(t, e);
}
...
function Le(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.We.isEqual(e.We) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || w(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof de && e instanceof de || t instanceof ve && e instanceof ve ? w(t.elements, e.elements, Tt) : t instanceof me && e instanceof me ? Tt(t.Ue, e.Ue) : t instanceof pe && e instanceof pe;
 ...
 */ function Ve(t) {
    return t instanceof ze ? t.version : D.min();
}
 ...
 */ var Se = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).key = e, i.value = n, i.We = r, i.type = 0 /* Set */ , 
        i;
    }
    return e.__extends(n, t), n;
    ...
    function n(e, n, r, i) {
        var o = this;
        return (o = t.call(this) || this).key = e, o.data = n, o.qe = r, o.We = i, o.type = 1 /* Patch */ , 
        o;
    }
    return e.__extends(n, t), n;
}(Te);
...
function Oe(t, e) {
    ...
    }(t, e instanceof ze ? e.data() : Fe.empty());
}
...
/** A mutation that deletes the document at the given key. */ var Me = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).key = e, r.We = n, r.type = 3 /* Delete */ , r;
    }
    return e.__extends(n, t), n;
}(Te), xe = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).key = e, r.We = n, r.type = 4 /* Verify */ , r;
    }
    return e.__extends(n, t), n;
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.ze = function() {
        var t = this.Xe(P.k(), this.Ye);
        return null != t ? new Fe(t) : this.He;
    }, 
    /**
    ...
    t.prototype.Xe = function(t, e) {
        var n = this, r = !1, i = this.He.field(t), o = xt(i) ? // If there is already data at the current path, base our
...
var Ge = function(t, e) {
    ...
    function n(e, n, r, i) {
        var o = this;
        return (o = t.call(this, e, n) || this).Ze = r, o.Ke = !!i.Ke, o.hasCommittedMutations = !!i.hasCommittedMutations, 
        o;
    }
 ...
 */ function Ke(t) {
    ...
    if (null === e.sn) {
        ...
        n.L() || e.sn.push(new _n(n)), e.sn.push(new _n(P.M(), "asc" /* ASCENDING */)); else {
 ...
 */ function Ze(t) {
    var e = Qe(t, Ye);
    if (!e.rn) if ("F" /* First */ === e.nn) e.rn = M(e.path, e.collectionGroup, Ke(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Ke(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new _n(o.field, s));
        }
        ...
        // Now return as a LimitType.First query.
                e.rn = M(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.rn;
}

function Xe(t, e, n) {
    return new Ye(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}

function tn(t, e) {
    return new Ye(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), t.limit, t.nn, e, t.endAt);
}

function en(t, e) {
    return new Ye(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), t.limit, t.nn, t.startAt, e);
}

function nn(t, e) {
    return F(Ze(t), Ze(e)) && t.nn === e.nn;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function sn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.W(t.collectionGroup) && t.path.C(n) : O.j(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
        ...
        return !(t.startAt && !wn(t.startAt, Ke(t), e)) && (!t.endAt || !wn(t.endAt, Ke(t), e));
    }(t, e);
}
...
var an = /** @class */ function(t) {
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        if (t.L()) return "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.dn(t, e, r) : new cn(t, e, r);
        if (Ct(r)) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.wn(Rt(e, this.value)) : null !== e && At(this.value) === At(e) && this.wn(Rt(e, this.value));
...
var cn = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, r) || this).key = O.B(r.referenceValue), i;
    }
    return e.__extends(n, t), n.prototype.matches = function(t) {
        var e = O.P(t.key, this.key);
        return this.wn(e);
    }, n;
...
/** A Filter that implements the array-contains operator. */ var pn = /** @class */ function(t) {
    ...
    return e.__extends(n, t), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return qt(e) && kt(e.arrayValue, this.value);
    }, n;
 ...
 */ function wn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.L() ? O.P(O.B(s.referenceValue), n.key) : Rt(s, n.field(o.field)), 
...
function En(t, e, n) {
    var r = t.field.L() ? O.P(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? Rt(r, i) : p();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var Nn = /** @class */ function() {
    ...
    t.prototype.In = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Re(i, e, e, this.mn));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = Re(a, e, o, this.mn));
        }
        return e;
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = ot, o = e.mutations, s = 0; s < o.length; s++) i = i.st(o[s].key, r[s].version);
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.gn && p(), this.gn = !0, this.pn ? this.error ? this.vn(n, this.error) : this.bn(e, this.result) : new t((function(t, i) {
            r.Vn = function(n) {
                r.bn(e, n).next(t, i);
            }, r.yn = function(e) {
                r.vn(n, e).next(t, i);
 ...
 */
        return function(t) {
            return O.j(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.jn(t, e.path) : Je(e) ? this.Gn(t, e, n) : this.Kn(t, e, n);
    }, t.prototype.jn = function(t, e) {
        // Just do a simple document lookup.
        return this.On(t, new O(e)).next((function(t) {
            var e = it();
            return t instanceof ze && (e = e.st(t.key, t)), e;
        }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Yn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = Re(a, h, h, o.mn);
                    r = f instanceof ze ? r.st(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        return this.Nn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof ze && (c = c.st(t, e));
            })), c;
        }));
    }, t;
}(), Rn = /** @class */ function() {
...
/** The result of applying a mutation batch to the backend. */ Dn.rs = -1;
...
var Ln = function() {
    ...
    t.prototype.ws = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && c("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.ls + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Sn(t) {
 ...
 * limitations under the License.
 */
/** The Platform's 'document' implementation or null if not available. */ function Pn() {
 ...
 */ var On = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Rs = t, this.hs = e, this.As = n, this.op = r, this.Ps = i, this.Vs = new Ln, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.ps && (this.clearTimeout(), this.Vs.reject(new k(T.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.ks = new Vn(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Os = function() {
            var e = Pn();
            e && c("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.ks.Es();
        };
        var e = Pn();
    ...
    t.prototype.Ws = function() {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Ss[0]() ];

                  case 2:
                    return e.sent(), this.Ss.shift(), this.ks.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!Sn(t = e.sent())) throw t;
        ...
        var e = this, n = this.bs.then((function() {
            return e.Ns = !0, t().catch((function(t) {
                ...
                throw e.Fs = t, e.Ns = !1, h("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.Ts = function(t, e, n) {
        ...
        var i = On.ys(this, t, e, n, (function(t) {
            return r.Qs(t);
        }));
 ...
 */
function qn(t, e) {
    if (h("AsyncQueue", e + ": " + t), Sn(t)) return new k(T.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Cn.ni = -1, Cn.si = 1048576, Cn.ii = 41943040, Cn.ti = 10, Cn.ei = 1e3, Cn.ri = new Cn(Cn.ii, Cn.ti, Cn.ei), 
Cn.oi = new Cn(Cn.ni, 0, 0);
...
var Mn = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.S(), n = t.g(), r = this.index[e] || new Z(V.P), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.S(), n = t.g(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Z(V.P)).F();
    }, t;
}(), Fn = /** @class */ function() {
    function t(t) {
        this.ui = t;
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.wi = D.min(), this.$n = t.mi(n), this.Ti = t.Ei(), this.Ii = t.Ri(), this.Ai = new kn(this.Ti, this.$n, this.persistence.Pi()), 
        this._i.Vi(this.Ai);
    }
...
function Bn(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = Tn.resolve();
            return o.forEach((function(t) {
                s = s.next((function() {
                    return r.Mn(e, t);
                })).next((function(e) {
                    var o = e, s = n.Pn.get(t);
                    d(null !== s), (!o || o.version.o(s) < 0) && ((o = i.Tn(t, o, n)) && 
 ...
 */ function zn(t, e) {
     ...
     */
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Gt.forEach((function(a, h) {
                var f = i.get(a);
                // Note: The order of the steps below is important, since we want
                // to ensure that rejected limbo resolutions (which fabricate
                // NoDocuments with SnapshotVersion.min()) never add documents to
                // cache.
                                h instanceof $e && h.version.isEqual(D.min()) ? (
                // NoDocuments with SnapshotVersion.min() are used in manufactured
                // events. We remove these documents from cache since we lost
                // access.
                o.Oi(a, r), u = u.st(a, h)) : null == f || h.version.o(f.version) > 0 || 0 === h.version.o(f.version) && f.hasPendingWrites ? (o.bi(h, r), 
            ...
            var h = n.Ii.Di(t).next((function(e) {
                return n.Ii.Mi(t, t.$i, r);
            }));
            s.push(h);
        }
        return Tn.Dn(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Ai.Bn(t, u);
        }));
    ...
    return e.__awaiter(this, void 0, void 0, (function() {
        ...
        return e.__generator(this, (function(e) {
            switch (e.label) {
              ...
              case 5:
                return i.fi = i.fi.remove(n), i.di.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function Qn(t, e, n) {
     ...
     */
        ...
        return function(t, e, n) {
            var r = y(t), i = r.di.get(n);
            return void 0 !== i ? Tn.resolve(r.fi.get(i)) : r.Ii.Ui(e, n);
        }(r, t, Ze(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Ii.Bi(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r._i.Qn(t, e, n ? i : D.min(), n ? o : ut());
        })).next((function(t) {
            return {
                documents: t,
                Wi: o
 ...
 */ var Hn = /** @class */ function() {
    ...
    t.prototype.Zi = function(t) {
        var e = this, n = new O(new V([])), r = new Jn(n, t), i = new Jn(n, t + 1), o = [];
        ...
        var e = new O(new V([])), n = new Jn(e, t), r = new Jn(e, t + 1), i = ut();
        return this.Gi.St([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.nr = function(t) {
        var e = new Jn(t, 0), n = this.Qi.Dt(e);
    ...
    return t.ji = function(t, e) {
        return O.P(t.key, e.key) || m(t.sr, e.sr);
    }, 
    /** Compare by ID then by key */ t.Ki = function(t, e) {
        return m(t.sr, e.sr) || O.P(t.key, e.key);
    }, t;
}(), Kn = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
/** A user with a null UID. */ Kn.UNAUTHENTICATED = new Kn(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
Kn.or = new Kn("google-credentials-uid"), Kn.hr = new Kn("first-party-uid");
...
var Zn = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = Kn.UNAUTHENTICATED, this.wr = !1, 
        /**
    ...
    t.prototype.Tr = function() {
        ...
        return d(null === t || "string" == typeof t), new Kn(t);
    }, t;
}(), er = /** @class */ function() {
    function t(t, e) {
        this.Er = t, this.Ir = e, this.type = "FirstParty", this.user = Kn.hr;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new er(this.Er, this.Ir));
    }, t.prototype.lr = function(t) {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.yr = 0, this.pr = null, this.stream = null, this.ks = new Vn(t, e)
        /**
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.kr(n) ];
    ...
    t.prototype.Or = function(t) {
        ...
        return function(n) {
            e.os.vs((function() {
                return e.yr === t ? n() : (c("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return e.__extends(n, t), n.prototype.Mr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Me ? (d(void 0 === e || "string" == typeof e), B.fromBase64String(e || "")) : (d(void 0 === e || e instanceof Uint8Array), 
                ...
                var c = Zt(t, a.document.name), h = Ht(a.document.updateTime), f = new Fe({
                    mapValue: {
                ...
                g.document;
                var m = Zt(t, g.document), w = g.readTime ? Ht(g.readTime) : D.min(), b = new $e(m, w), _ = g.removedTargetIds || [];
                n = new yt([], _, b.key, b);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var E = e.documentRemove;
                E.document;
                var I = Zt(t, E.document), N = E.removedTargetIds || [];
                n = new yt([], N, I, null);
            } else {
                ...
                var A = e.filter;
                A.targetId;
                var R = A.count || 0, L = new W(R), V = A.targetId;
                n = new vt(V, L);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? D.min() : e.readTime ? Ht(e.readTime) : D.min();
        }(t);
    ...
    n.prototype.Wr = function(t) {
        ...
        e.database = te(this.serializer), e.addTarget = function(t, e) {
            ...
            return (n = j(r) ? {
                ...
                query: ie(t, r)
            }).targetId = e.targetId, e.resumeToken.Y() > 0 && (n.resumeToken = Qt(t, e.resumeToken)), 
            n;
        }(this.serializer, t);
        var n = function(t, e) {
            var n = function(t, e) {
    ...
    n.prototype.Qr = function(t) {
        var e = {};
        e.database = te(this.serializer), e.removeTarget = t, this.Fr(e);
    }, n;
}(rr), or = /** @class */ function(t) {
    function n(e, n, r, i, o) {
        var s = this;
    ...
    return e.__extends(n, t), Object.defineProperty(n.prototype, "Gr", {
        /**
    ...
    n.prototype.start = function() {
        this.jr = !1, this.lastStreamToken = void 0, t.prototype.start.call(this);
        ...
        d(!!t.streamToken), this.lastStreamToken = t.streamToken, this.jr) {
        ...
        // The first response is always the handshake response
                return d(!t.writeResults || 0 === t.writeResults.length), this.jr = !0, 
        this.listener.Hr();
    }, 
    /**
    ...
    n.prototype.Yr = function() {
        ...
        var t = {};
        t.database = te(this.serializer), this.Fr(t);
    }, 
...
}(rr), sr = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).credentials = e, i.Pr = n, i.serializer = r, i.Jr = !1, 
        i;
    }
    return e.__extends(n, t), n.prototype.Xr = function() {
        if (this.Jr) throw new k(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Zr = function(t, e, n) {
        ...
        return this.Xr(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === T.UNAUTHENTICATED && r.credentials.cr(), t;
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.io ? (h(e), this.io = !1) : c("OnlineStateTracker", e);
    ...
    n, r, i, o) {
        ...
        /**
             ...
             */
        this.wo = new Set, this.mo = o, this.mo.To((function(t) {
            r.vs((function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Eo() ? (c("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.Ao = function(t, e, n) {
            var r = y(t);
            return r.Xr(), new ir(e, r.Pr, r.credentials, r.serializer, n);
        }(this.lo, r, {
            ...
            var r = y(t);
            return r.Xr(), new or(e, r.Pr, r.credentials, r.serializer, n);
        }(this.lo, r, {
    ...
    t.prototype.disableNetwork = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this._o.length > 0 && (c("RemoteStore", "Stopping write stream with " + this._o.length + " pending writes"), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return c("RemoteStore", "RemoteStore shutting down."), this.wo.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.$o() ];
    ...
    t.prototype.Mo = function(t) {
        ...
        this.do = new wt(this), this.Ao.start(), this.Ro.ro();
    }, 
    /**
    ...
    }, t.prototype.yo = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var r, i, o;
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (this.Ro.set("Online" /* Online */), !(t instanceof gt && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this.Uo(t) ];
                  ...
                  case 6:
                    if (t instanceof yt ? this.do.Ve(t) : t instanceof vt ? this.do.De(t) : this.do.ge(t), 
                    n.isEqual(D.min())) return [ 3 /*break*/ , 13 ];
                    e.label = 7;

                  case 7:
                    return e.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Gn(this.co) ];

                  case 8:
                    return i = e.sent(), n.o(i) >= 0 ? [ 4 /*yield*/ , this.Wo(n) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return c("RemoteStore", "Failed to raise snapshot:", o = e.sent()), [ 4 /*yield*/ , this.Bo(o) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    // Disable network and raise offline snapshots
                    return i.sent(), this.Ro.set("Offline" /* Offline */), n || (
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.fo.has(o) ? [ 4 /*yield*/ , this.qo.Go(o, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    e.sent(), this.fo.delete(o), this.do.removeTarget(o), e.label = 3;
    ...
    t.prototype.No = function() {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    t = this._o.length > 0 ? this._o[this._o.length - 1].batchId : -1, e.label = 1;
                  ...
                  case 2:
                    return e.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , $n(this.co, t) ];

                  case 3:
                    return null === (n = e.sent()) ? (0 === this._o.length && this.po.Cr(), [ 3 /*break*/ , 7 ]) : (t = n.batchId, 
                    this.zo(n), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = e.sent(), [ 4 /*yield*/ , this.Bo(r) ];
    ...
    t.prototype.zo = function(t) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                for (t = 0, n = this._o; t < n.length; t++) r = n[t], this.po.Kr(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = this._o.shift(), i = An.from(r, t, n), [ 4 /*yield*/ , this.Qo((function() {
                        return o.qo.Xo(i);
                    })) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return Q(r = t.code) && r !== T.ABORTED ? (n = this._o.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.po.Sr(), [ 4 /*yield*/ , this.Qo((function() {
                        return i.qo.th(n.batchId, t);
                    })) ]) : [ 3 /*break*/ , 3 ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    c("RemoteStore", "RemoteStore received new credentials"), this.wo.add(3 /* CredentialChange */), 
                    [ 4 /*yield*/ , this.$o() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 2:
                    return (n = t) ? [ 3 /*break*/ , 4 ] : (this.wo.add(2 /* IsSecondary */), [ 4 /*yield*/ , this.$o() ]);

                  case 3:
                    e.sent(), n = this.Ro.set("Unknown" /* Unknown */), e.label = 4;
    ...
    function t() {
        this.oh = new cr, this.hh = {}, this.eo = null, this.ts = null;
    }
    return t.prototype.ah = function(t) {
        ...
        return this.oh = new cr, Promise.resolve();
    ...
    e) {
        ...
        this.qt = ut(), this.Vh = un(t), this.yh = new ht(this.Vh);
    }
    ...
    t.prototype.gh = function(t, e) {
        var n = this, r = e ? e.vh : new ft, i = e ? e.yh : this.yh, o = e ? e.qt : this.qt, s = i, u = !1, a = this.query.an() && i.size === this.query.limit ? i.last() : null, c = this.query.un() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.Ch = function(t, e, n) {
        ...
        return this.Ah = u, 0 !== o.length || a ? {
            snapshot: new lt(this.query, t.yh, i, o, t.qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Nh: s
        } : {
            Nh: s
    ...
    t.prototype.Dh = function(t) {
        ...
        // updating many documents.
                var e = this.Ph;
        this.Ph = ut(), this.yh.forEach((function(e) {
            t.kh(e.key) && (t.Ph = t.Ph.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Ph.has(e) || n.push(new lr(e));
        })), this.Ph.forEach((function(t) {
            e.has(t) || n.push(new fr(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.xh = function() {
        return lt.Wt(this.query, this.yh, this.qt, 0 /* Local */ === this.Ah);
    }, t;
}(), dr = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.Bh = null, this.Wh = new A((function(t) {
            return rn(t);
        }), nn), this.Qh = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Kh = new Map, this.zh = new Hn, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Hh = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Yh = new Map, this.Jh = Fn.li(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return Object.defineProperty(t.prototype, "Zh", {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    n = i.targetId, this.qh.lh(n), r = i.view.xh(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];
             ...
             */
                    function(t, e) {
                        ...
                        return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
                            ...
                            return n.Ii.Ui(t, e).next((function(i) {
                                ...
                                r = i, Tn.resolve(r)) : n.Ii.ea(t).next((function(i) {
                                    return r = new $(e, i, 0 /* Listen */ , t.$i), n.Ii.na(t, r).next((function() {
                                        return r;
                                    }));
                                }));
                            }));
                  ...
                  case 2:
                    return o = e.sent(), s = this.qh.lh(o.targetId), n = o.targetId, [ 4 /*yield*/ , this.sa(t, n, "current" === s) ];

                  case 3:
                    r = e.sent(), this.Zh && this.Mh.listen(o), e.label = 4;
     ...
     * snapshot.
     */
    t.prototype.sa = function(t, n, r) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var i, o, s, u, a, c;
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , Qn(this.co, t, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return i = e.sent(), o = new pr(t, i.Wi), s = o.gh(i.documents), u = dt.Ht(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Ch(s, 
                    /* updateLimboDocuments= */ this.Zh, u), this.ia(n, a.Nh), c = new dr(t, n, o), 
                    [ 2 /*return*/ , (this.Wh.set(t, c), this.Qh.has(n) ? this.Qh.get(n).push(t) : this.Qh.set(n, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.ta("unlisten()"), n = this.Wh.get(t), (r = this.Qh.get(n.targetId)).length > 1 ? [ 2 /*return*/ , (this.Qh.set(n.targetId, r.filter((function(e) {
                        return !nn(e, t);
                    }))), void this.Wh.delete(t)) ] : this.Zh ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.qh.fh(n.targetId), this.qh.Th(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Wn(this.co, n.targetId, 
                    /*keepPersistedTargetData=*/ !1).then((function() {
                        i.qh.wh(n.targetId), i.Mh.Lo(n.targetId), i.ra(n.targetId);
                    })).catch(Yn) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.ra(n.targetId), [ 4 /*yield*/ , Wn(this.co, n.targetId, 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.ta("write()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , 
                    /* Accepts locally generated Mutations and commit them to storage. */
                    function(t, e) {
                        var n, r = y(t), i = R.now(), o = e.reduce((function(t, e) {
                            return t.add(e.key);
                        }), ut());
                        return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                            return r.Ai.Un(t, o).next((function(o) {
                                ...
                                var s = [], u = 0, a = e; u < a.length; u++) {
                                    var c = a[u], h = De(c, n.get(c.key));
                                    null != h && 
                                    // NOTE: The base state should only be applied if there's some
                                    // existing document to override, so use a Precondition of
                                    // exists=true
                                    s.push(new Pe(c.key, h, Be(h.proto.mapValue), Ne.exists(!0)));
                                }
                  ...
                  case 2:
                    return r = e.sent(), this.qh.ah(r.batchId), this.aa(r.batchId, n), [ 4 /*yield*/ , this.ua(r.ha) ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.Mh.No() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.ta("applyRemoteEvent()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , zn(this.co, t) ];
                  ...
                  case 2:
                    ...
                    t.Qt.forEach((function(t, e) {
                        ...
                        d(t.Jt.size + t.Xt.size + t.Zt.size <= 1), t.Jt.size > 0 ? n.Lh = !0 : t.Xt.size > 0 ? d(n.Lh) : t.Zt.size > 0 && (d(n.Lh), 
                        n.Lh = !1));
                    })), [ 4 /*yield*/ , this.ua(n, t) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.qh._h(t, "rejected", n), r = this.Kh.get(t), (i = r && r.key) ? (o = (o = new H(O.P)).st(i, new $e(i, D.min())), 
                    s = ut().add(i), u = new pt(D.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Z(m), o, s), [ 4 /*yield*/ , this.jo(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.ta("applySuccessfulWrite()"), n = t.batch.batchId, e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Bn(this.co, t) ];
                  ...
                  case 2:
                    ...
                    this._a(n, /*error=*/ null), this.fa(n), this.qh.uh(n, "acknowledged"), [ 4 /*yield*/ , this.ua(r) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.ta("rejectFailedWrite()"), e.label = 1;
                    ...
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                        ...
                        return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                            ...
                            return n.$n.da(t, e).next((function(e) {
                                return d(null !== e), r = e.keys(), n.$n.Si(t, e);
                            })).next((function() {
                                return n.$n.Ci(t);
                            })).next((function() {
                                return n.Ai.Un(t, r);
                  ...
                  case 2:
                    ...
                    // listen events.
                    this._a(t, n), this.fa(t), this.qh.uh(t, "rejected", n), [ 4 /*yield*/ , this.ua(r) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Mh.Eo() || c("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    e.label = 1;
                  ...
                  case 2:
                    return -1 === (n = e.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Yh.get(n) || []).push(t), 
                    this.Yh.set(n, r), [ 3 /*break*/ , 4 ]);
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Ta = function(t) {
        ...
        n || (n = new H(m)), n = n.st(t, e), this.Hh[this.currentUser.rr()] = n;
    }, 
    /**
    ...
    t.prototype._a = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof fr ? (this.zh.zi(i.key, t), this.Ra(i)) : i instanceof lr ? (c("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.Gh.get(e) || (c("SyncEngine", "New document in limbo: " + e), this.jh.push(e), 
        this.la());
    }, 
    /**
    ...
    t.prototype.la = function() {
        for (;this.jh.length > 0 && this.Gh.size < this.Uh; ) {
            ...
            this.Kh.set(e, new yr(t)), this.Gh = this.Gh.st(t, e), this.Mh.listen(new $(Ze(He(t.path)), e, 2 /* LimboResolution */ , Dn.rs));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.Pa = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(u) {
                switch (u.label) {
                  case 0:
                    return r = [], i = [], o = [], this.Wh.forEach((function(e, u) {
                        o.push(Promise.resolve().then((function() {
                            var e = u.view.gh(t);
                            return e.Sh ? Qn(s.co, u.query, 
                            /* usePreviousResults= */ !1).then((function(t) {
                                var n = t.documents;
                                return u.view.gh(n, e);
                            })) : e;
                            // The query has a limit and some docs were removed, so we need
                            // to re-run the query against the local store to make sure we
                            // didn't lose any good docs that had been past the limit.
                                                })).then((function(t) {
                            var e = n && n.Qt.get(u.targetId), o = u.view.Ch(t, 
                            /* updateLimboDocuments= */ s.Zh, e);
                            if (s.ia(u.targetId, o.Nh), o.snapshot) {
                                s.Zh && s.qh._h(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), r.push(o.snapshot);
                                var a = Rn.Zn(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return u.sent(), this.Bh.Br(r), [ 4 /*yield*/ , function(t, n) {
                        return e.__awaiter(this, void 0, void 0, (function() {
                                ...
                                switch (e.label) {
                                  ...
                                  case 1:
                                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , r.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                        return Tn.forEach(n, (function(e) {
                                            return Tn.forEach(e.Jn, (function(n) {
                                                return r.persistence.Li.zi(t, e.targetId, n);
                                            })).next((function() {
                                                return Tn.forEach(e.Xn, (function(n) {
                                                    return r.persistence.Li.Yi(t, e.targetId, n);
                                                }));
                                            }));
                                        }));
                                    })) ];
                                  ...
                                  case 4:
                                    for (o = 0, s = n; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (h = r.fi.get(a), 
                                    f = h.Z, l = h.nt(f), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (c("SyncEngine", "User change. New user:", t.rr()), 
                    [ 4 /*yield*/ , 
                    /**
                 ...
                 */
                    ...
                    function(t, n) {
                        return e.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return r = y(t), i = r.$n, o = r.Ai, [ 4 /*yield*/ , r.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                                        // Swap out the mutation queue, grabbing the pending mutation batches
                                        // before and after.
                                        var e;
                                        return r.$n.Va(t).next((function(s) {
                                            return e = s, i = r.persistence.mi(n), 
                                            // Recreate our LocalDocumentsView using the new
                                            // MutationQueue.
                                            o = new kn(r.Ti, i, r.persistence.Pi()), i.Va(t);
                                        })).next((function(n) {
                                  ...
                                  case 1:
                                    return s = e.sent(), [ 2 /*return*/ , (r.$n = i, r.Ai = o, r._i.Vi(r.Ai), s) ];
                                }
                            }));
                        }));
                    }(this.co, t) ]);
                  ...
                  case 1:
                    ...
                    this.qh.Eh(t, n.pa, n.ga), [ 4 /*yield*/ , this.ua(n.ya) ];
        ...
        var e = this.Kh.get(t);
        if (e && e.Lh) return ut().add(e.key);
        var n = ut(), r = this.Qh.get(t);
        if (!r) return n;
    ...
    function t(t) {
        this.qo = t, this.ba = new A((function(t) {
            return rn(t);
        }), nn), this.onlineState = "Unknown" /* Unknown */ , this.Sa = new Set, this.qo.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.ba.get(n)) || (r = !0, i = new gr), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.qo.listen(n) ];

                  case 2:
                    return o.va = e.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = e.sent(), u = qn(s, "Initialization of query '" + on(t.query) + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.ba.set(n, i), i.listeners.push(t), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return e.__generator(this, (function(e) {
                return n = t.query, r = !1, (i = this.ba.get(n)) && (o = i.listeners.indexOf(t)) >= 0 && (i.listeners.splice(o, 1), 
                r = 0 === i.listeners.length), r ? [ 2 /*return*/ , (this.ba.delete(n), this.qo.Lo(n)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    return t.prototype.Ca = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new lt(t.query, t.docs, t.Mt, e, t.qt, t.fromCache, t.Ut, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.$h = function(t) {
        ...
        t = lt.Wt(t.query, t.docs, t.qt, t.fromCache), this.ka = !0, this.$a.next(t);
    }, t;
}(), br = /** @class */ function() {
    function t() {}
    return t.prototype.Vi = function(t) {
        this.Ua = t;
    }, t.prototype.Qn = function(t, e, n, i) {
        var o = this;
        // Queries that match all documents don't benefit from using
        // IndexFreeQueries. It is more efficient to scan all documents in a
        // collection, rather than to perform individual lookups.
                return e.hn() || n.isEqual(D.min()) ? this.Ba(t, e) : this.Ua.Un(t, i).next((function(s) {
            var u = o.Wa(e, s);
            return (e.an() || e.un()) && o.Sh(e.nn, u, i, n) ? o.Ba(t, e) : (a() <= r.LogLevel.DEBUG && c("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), on(e)), 
            o.Ua.Qn(t, e, n).next((function(t) {
    ...
    return t.prototype.Ga = function(t) {
        return Tn.resolve(0 === this.$n.length);
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.ja = this.ja.add(new Jn(a.key, i)), this.kn.ai(t, a.key.path.g());
        }
        return Tn.resolve(o);
    }, t.prototype.da = function(t, e) {
        return Tn.resolve(this.Ka(e));
    }, t.prototype.qi = function(t, e) {
        var n = e + 1, r = this.za(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Tn.resolve(this.$n.length > i ? this.$n[i] : null);
    }, t.prototype.ma = function() {
        return Tn.resolve(0 === this.$n.length ? -1 : this.Qa - 1);
    }, t.prototype.Va = function(t) {
        return Tn.resolve(this.$n.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                O.j(i) || (i = i.child(""));
        var o = new Jn(new O(i), 0), s = new Z(m);
        ...
        var n = this;
        d(0 === this.Ya(e.batchId, "removed")), this.$n.shift();
        var r = this.ja;
        ...
        var n = new Jn(e, 0), r = this.ja.Dt(n);
        return Tn.resolve(e.isEqual(r && r.key));
    }, t.prototype.Ci = function(t) {
        return this.$n.length, Tn.resolve();
    }, 
    /**
    ...
    t.prototype.Oi = function(t) {
        ...
        for (var r = it(), i = new O(e.path.child("")), o = this.docs.ct(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.Tt(); ) {
            var s = o.wt(), u = s.key, a = s.value, c = a.tu, h = a.readTime;
            if (!e.path.C(u.path)) break;
            h.o(n) <= 0 || c instanceof ze && sn(e, c) && (r = r.st(c.key, c));
        }
        return Tn.resolve(r);
 ...
 */
Er.nu = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).uu = e, n;
    }
    return e.__extends(n, t), n.prototype.Ch = function(t) {
        var e = this, n = [];
    ...
    t.prototype.Mn = function(t, e) {
        this.ou();
        var n = this.ha.get(e);
        return void 0 !== n ? Tn.resolve(n) : this.hu(t, e);
    }, 
    /**
...
var Ir = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._u = new Hn, this.targetCount = 0, this.fu = Fn.ci();
    }
    return t.prototype.ve = function(t, e) {
        ...
        return Tn.resolve(this.lu);
    }, t.prototype.ea = function(t) {
        return this.highestTargetId = this.fu.next(), Tn.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.fu = new Fn(e), this.highestTargetId = e), t.sequenceNumber > this.lu && (this.lu = t.sequenceNumber);
    }, t.prototype.na = function(t, e) {
        return this.wu(e), this.targetCount += 1, Tn.resolve();
    }, t.prototype.ki = function(t, e) {
        return this.wu(e), Tn.resolve();
        ...
        return this._u.Hi(e, n), Tn.resolve();
        ...
        return this._u.Zi(e), Tn.resolve();
    }, t.prototype.Bi = function(t, e) {
        var n = this._u.er(e);
        return Tn.resolve(n);
    }, t.prototype.nr = function(t, e) {
        return Tn.resolve(this._u.nr(e));
    }, t;
}(), Nr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Ru = {}, this.Au = new Dn(0), this.Pu = !1, this.Pu = !0, this.Li = t(this), 
        this.Ii = new Ir(this), this.kn = new Mn, this.Nn = new Er(this.kn, (function(t) {
            return e.Li.Vu(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Ru[t.rr()];
        return e || (e = new _r(this.kn, this.Li), this.Ru[t.rr()] = e), e;
        ...
        return Tn.Fn(Object.values(this.Ru).map((function(n) {
            return function() {
                return n.nr(t, e);
            };
        })));
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).$i = e, n;
    }
    /**
    ...
    return t.ku = function(e) {
        ...
        return this.Nu.zi(n, e), this.Ou.delete(n.toString()), Tn.resolve();
    }, t.prototype.Yi = function(t, e, n) {
        return this.Nu.Yi(n, e), this.Ou.add(n.toString()), Tn.resolve();
    }, t.prototype.Ja = function(t, e) {
        return this.Ou.add(e.toString()), Tn.resolve();
        ...
        // Remove newly orphaned documents.
                return Tn.forEach(this.Ou, (function(r) {
            var i = O.U(r);
        ...
        var n = this;
        return Tn.Fn([ function() {
            return Tn.resolve(n.Nu.nr(e));
        }, function() {
     ...
     * HTTP).
     */
    return e.__extends(n, t), n.prototype.Ju = function(t, e, n, r) {
        ...
        var n = [ this.Ku, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = o.createWebChannelTransport(), s = {
        ...
        this.Yu(s.initMessageHeaders, e), 
        ...
        var a = r.createWebChannel(u, s), h = !1, l = !1, p = new kr({
            Lu: function(t) {
        ...
        return y(o.WebChannel.EventType.OPEN, (function() {
            ...
            l || (l = !0, c("Connection", "WebChannel transport closed"), p.Qu());
        })), y(o.WebChannel.EventType.ERROR, (function(t) {
            l || (l = !0, f("Connection", "WebChannel transport errored:", t), p.Qu(new k(T.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!l) {
                ...
                if (i) {
                    ...
                    l = !0, p.Qu(new k(s, u)), a.close();
                } else c("Connection", "WebChannel received:", n), p.ju(n);
            }
        })), setTimeout((function() {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Pr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Or = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new br, r = t.cc, new jn(e, n, r);
        var e, n, r;
    }, t.prototype.oc = function(t) {
        if (t._c.lc) throw new k(T.FAILED_PRECONDITION, Pr);
        return new Nr(Tr.ku);
        ...
        throw new k(T.FAILED_PRECONDITION, Pr);
    }, t;
}(), Ur = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.co ? [ 3 /*break*/ , 3 ] : (this.co = t.co, this.qh = t.qh, this.lo = this.fc(n), 
                    this.Mh = this.dc(n), this.qo = this.wc(n), this.mc = this.Tc(n), this.qh.eo = function(t) {
                        return r.qo.$h(t, 1 /* SharedClientState */);
                    }, this.Mh.qo = this.qo, [ 4 /*yield*/ , this.Mh.start() ]);

                  case 1:
                    return e.sent(), [ 4 /*yield*/ , this.Mh.nh(this.qo.Zh) ];
        ...
        return new mr(this.qo);
    }, t.prototype.fc = function(t) {
        var e, n = Sr(t.Gu.s), r = (e = t.Gu, new Dr(e));
        /** Return the Platform-specific connectivity monitor. */ return function(t, e, n) {
            return new sr(t, e, n);
        }(t.credentials, r, n);
    }, t.prototype.dc = function(t) {
        var e = this;
        return new ar(this.co, this.lo, t.Rs, (function(t) {
 ...
 */ function Mr(t, e) {
    if (0 !== e.length) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + ni(e.length, "argument") + ".");
}
 ...
 */ function xr(t, e, n) {
    if (e.length !== n) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires " + ni(n, "argument") + ", but was called with " + ni(e.length, "argument") + ".");
}
 ...
 */ function Fr(t, e, n) {
    if (e.length < n) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires at least " + ni(n, "argument") + ", but was called with " + ni(e.length, "argument") + ".");
}
 ...
 */ function jr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + ni(e.length, "argument") + ".");
}
 ...
 */ function Qr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new k(T.INVALID_ARGUMENT, "Invalid value " + Jr(r) + " provided to function " + t + "() for its " + ei(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function Yr(t, e, n, r) {
    if (!("object" === e ? Hr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Jr(r);
...
function Kr(t, e, n) {
    if (void 0 === n) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + ei(e) + " argument, but it was undefined.");
}
 ...
 */ function Xr(t, e, n, r) {
    var i = Jr(r);
    return new k(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + ei(n) + " argument to be a " + e + ", but it was: " + i);
}

function ti(t, e, n) {
    if (n <= 0) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + ei(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function ei(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function ri() {
 ...
 */ var oi = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        xr("Blob.fromBase64String", arguments, 1), Br("Blob.fromBase64String", "string", 1, e), 
        ii();
        try {
        ...
        if (xr("Blob.fromUint8Array", arguments, 1), ri(), !(e instanceof Uint8Array)) throw Xr("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(B.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return xr("Blob.toBase64", arguments, 0), ii(), this.Rc.toBase64();
    }, t.prototype.toUint8Array = function() {
        return xr("Blob.toUint8Array", arguments, 0), ri(), this.Rc.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new k(T.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + ni(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Br("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new k(T.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Ac = new P(t);
}, ui = /** @class */ function(t) {
    /**
    ...
    return e.__extends(n, t), n.documentId = function() {
        ...
        if (!(t instanceof n)) throw Xr("isEqual", "FieldPath", 1, t);
        return this.Ac.isEqual(t.Ac);
    }, n;
}(si), ai = new RegExp("[~\\*/\\[\\]]"), ci = function() {
    /** A pointer to the implementing class. */
    this.Pc = this;
}, hi = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Vc = e, n;
    }
    return e.__extends(n, t), n.prototype.yc = function(t) {
...
var li = /** @class */ function(t) {
...
}(ci), pi = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).Vc = e, r.Sc = n, r;
    }
    return e.__extends(n, t), n.prototype.yc = function(t) {
        var e = fi(this, t, 
...
}(ci), yi = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).Vc = e, r.Cc = n, r;
    }
    return e.__extends(n, t), n.prototype.yc = function(t) {
        var e = new me(t.serializer, $t(t.serializer, this.Cc));
        return new Ee(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(ci), vi = /** @class */ function(t) {
    function n() {
        return t.call(this) || this;
    }
    return e.__extends(n, t), n.delete = function() {
        return Mr("FieldValue.delete", arguments), new gi(new hi("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Mr("FieldValue.serverTimestamp", arguments), new gi(new li("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Fr("FieldValue.arrayUnion", arguments, 1), new gi(new pi("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Fr("FieldValue.arrayRemove", arguments, 1), new gi(new di("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return Br("FieldValue.increment", "number", 1, t), xr("FieldValue.increment", arguments, 1), 
        new gi(new yi("FieldValue.increment", t));
    }, n;
}(ci), gi = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Pc = e, n.Vc = e.Vc, n;
    }
    return e.__extends(n, t), n.prototype.yc = function(t) {
        return this.Pc.yc(t);
    }, n.prototype.isEqual = function(t) {
...
}(vi), mi = /** @class */ function() {
    function t(t, e) {
        if (xr("GeoPoint", arguments, 2), Br("GeoPoint", "number", 1, t), Br("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.m = function(t) {
        return m(this.Dc, t.Dc) || m(this.Fc, t.Fc);
    }, t;
}(), wi = /^__.*__$/, bi = function(t, e, n) {
    ...
    return t.prototype.Oc = function(t, e) {
        var n = [];
        return null !== this.qe ? n.push(new Pe(t, this.data, this.qe, e)) : n.push(new Se(t, this.data, e)), 
...
/** A "context" object passed around while parsing user data. */ var Ni = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Lc = function(e) {
        ...
        return qi(t, this.settings.methodName, this.settings.Wc || !1, this.path, this.settings.vc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Ii(this.pc) && wi.test(t)) throw this.gc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ai = /** @class */ function() {
    function t(t, e, n) {
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function Ti(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Qc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Pi("Data must be an object, but it was:", s, r);
    var u, a, c = Vi(r, s);
    if (o.merge) u = new _e(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = l[f], y = void 0;
            if (d instanceof si) y = d.Ac; else {
        ...
        u = new _e(h), a = s.fieldTransforms.filter((function(t) {
            return u.je(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new _i(new Fe(c), u, a);
}

/** Parse update data from an update() call. */ function ki(t, e, n, r) {
    var i = t.Qc(1 /* Update */ , e, n);
    Pi("Data must be an object, but it was:", i, r);
    var o = [], s = new je;
    I(r, (function(t, r) {
        var u = Ui(e, t, n), a = i.Uc(u);
        if (r instanceof ci && r.Pc instanceof hi) 
    ...
    var u = new _e(o);
    return new Ei(s.ze(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Ri(t, e, n, r, i, o) {
    var s = t.Qc(1 /* Update */ , e, n), u = [ Oi(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(Oi(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new je, l = u.length - 1; l >= 0; --l) if (!Ci(h, u[l])) {
        var p = u[l], d = a[l], y = s.Uc(p);
        if (d instanceof ci && d.Pc instanceof hi) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var v = Li(d, y);
    ...
    var g = new _e(h);
    return new Ei(f.ze(), g, s.fieldTransforms);
}
 ...
 */ function Di(t, e, n, r) {
    return void 0 === r && (r = !1), Li(n, t.Qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Li(t, e) {
    if (Si(t)) return Pi("Unsupported field value:", e, t), Vi(t, e);
    if (t instanceof ci) 
    ...
    return function(t, e) {
        ...
        if (!Ii(e.pc)) throw e.gc(t.Vc + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof R) {
            ...
            var r = new R(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
        ...
        if (t instanceof bi) {
            ...
            return {
                referenceValue: Jt(t.Nc || e.s, t.$c.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.gc("Unsupported field value: " + Jr(t));
    }(t, e);
}
...
function Si(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof R || t instanceof mi || t instanceof oi || t instanceof bi || t instanceof ci);
}
 ...
 */ function Oi(t, e, n) {
    if (e instanceof si) return e.Ac;
 ...
 */ function Ui(t, n, r) {
    try {
        return function(t) {
            if (t.search(ai) >= 0) throw new k(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (ui.bind.apply(ui, e.__spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new k(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(n).Ac;
    } catch (n) {
        throw qi((i = n) instanceof Error ? i.message : i.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
    /**
 ...
 */ var Mi = /** @class */ function() {
    ...
    return t.prototype.Hc = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.Yc(), this.mutations.length > 0) throw new k(T.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                                  ...
                                  case 0:
                                    return r = y(t), i = te(r.serializer) + "/documents", o = {
                                        documents: n.map((function(t) {
                                            return Kt(r.serializer, t);
                                        }))
                                    }, [ 4 /*yield*/ , r.to("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = e.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Zt(t, e.found.name), r = Ht(e.found.updateTime), i = new Fe({
                                                    mapValue: {
                                                ...
                                                var n = Zt(t, e.missing), r = Ht(e.readTime);
                                                return new $e(n, r);
                                            }(t, e) : p();
                                        }(r.serializer, t);
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof $e || t instanceof ze ? r.Jc(t) : p();
                    })), n) ];
                }
            }));
        }));
        ...
        this.write([ new Me(t, this.We(t)) ]), this.zc.add(t.toString());
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var r = O.U(e);
                        n.mutations.push(new xe(r, n.We(r)));
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return r.sent(), this.Gc = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.We = function(t) {
        ...
        return !this.zc.has(t.toString()) && e ? Ne.updateTime(e) : Ne.Ge();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.Rs = t, this.lo = e, this.updateFunction = n, this.Vs = r, this.Zc = 5, this.ks = new Vn(this.Rs, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.ks.ws((function() {
            return e.__awaiter(t, void 0, void 0, (function() {
                var t, n, r = this;
                return e.__generator(this, (function(e) {
                    return t = new Mi(this.lo), (n = this.el(t)) && n.then((function(e) {
                        r.Rs.vs((function() {
        ...
        try {
            ...
            return !U(e) && e.catch && e.then ? e : (this.Vs.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
     ...
     */
    e) {
        this.credentials = t, this.Rs = e, this.clientId = g.t(), 
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.lr((function(t) {
            if (!s) return s = !0, c("FirestoreClient", "Initializing. user=", t.uid), i.ol(e, n, r, t, o).then(i.il.resolve, i.il.reject);
            i.Rs.Bs((function() {
                return i.Mh.eh(t);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.ol = function(t, n, r, i, o) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var s, u, a = this;
            return e.__generator(this, (function(c) {
                switch (c.label) {
                  ...
                  case 2:
                    return c.sent(), this.persistence = t.persistence, this.qh = t.qh, this.co = t.co, 
                    this.hc = t.hc, this.lo = n.lo, this.Mh = n.Mh, this.qo = n.qo, this.hl = n.mc, 
    ...
    t.prototype.rl = function() {
        if (this.Rs.xs) throw new k(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
            ...
            return e.__awaiter(t, void 0, void 0, (function() {
                ...
                return e.__generator(this, (function(e) {
                    switch (e.label) {
                      ...
                      case 1:
                        return e.sent(), [ 4 /*yield*/ , this.qh.Oo() ];

                      case 2:
                        return e.sent(), [ 4 /*yield*/ , this.persistence.Oo() ];
                      ...
                      case 3:
                        ...
                        // auth tokens.
                        this.credentials._r(), n.resolve(), [ 3 /*break*/ , 5 ];

                      case 4:
                        return t = e.sent(), r = qn(t, "Failed to shutdown persistence"), n.reject(r), [ 3 /*break*/ , 5 ];
    ...
    t.prototype.waitForPendingWrites = function() {
                    ...
                    return [ 2 /*return*/ , (n.sent(), function(t, n, r) {
                        return e.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(s) {
                                switch (s.label) {
                                  case 0:
                                    return i = new Ln, [ 4 /*yield*/ , t.enqueue((function() {
                                        return e.__awaiter(o, void 0, void 0, (function() {
                                            ...
                                            return e.__generator(this, (function(e) {
                                                switch (e.label) {
                                                  ...
                                                  case 1:
                                                    return (t = e.sent()) instanceof ze ? i.resolve(t) : t instanceof $e ? i.resolve(null) : i.reject(new k(T.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];
                ...
                switch (e.label) {
                  ...
                  case 1:
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Ln, o = ji(t, e, He(n.path), {
                                    ...
                                    return i = new Ln, [ 4 /*yield*/ , t.enqueue((function() {
                                        return e.__awaiter(o, void 0, void 0, (function() {
                                            ...
                                            return e.__generator(this, (function(e) {
                                                switch (e.label) {
                                                  case 0:
                                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Qn(n, r, 
                                                    /* usePreviousResults= */ !0) ];

                                                  case 1:
                                                    return t = e.sent(), o = new pr(r, t.Wi), s = o.gh(t.documents), u = o.Ch(s, 
        ...
        return this.Rs.vs((function() {
            return e.__awaiter(n, void 0, void 0, (function() {
                return e.__generator(this, (function(t) {
                    return [ 2 /*return*/ , this.hl.Fa(r) ];
                }));
            }));
        })), function() {
            r.Ic(), n.Rs.vs((function() {
                return e.__awaiter(n, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        return [ 2 /*return*/ , this.hl.Na(r) ];
                    }));
                }));
            }));
        };
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new Ln;
        return this.Rs.vs((function() {
            return new xi(e.Rs, e.lo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var Bi = /** @class */ function() {
    ...
    return t.prototype.ml = function(t) {
        ...
        return new mi(St(t.latitude), St(t.longitude));
    }, t.prototype.Al = function(t) {
        var e = this;
        ...
        var e = Vt(t), n = new R(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.Il = function(t) {
        var e = V.$(t);
        d(ae(e));
        var n = new _(e.get(1), e.get(3)), r = new O(e.p(5));
...
}(), Gi = Cn.ni, zi = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new k(T.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else zr("settings", "non-empty string", "host", t.host), this.host = t.host, $r("settings", "boolean", "ssl", t.ssl), 
        ...
        $r("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        $r("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), $r("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        $r("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Cn.ii; else {
            if (t.cacheSizeBytes !== Gi && t.cacheSizeBytes < Cn.si) throw new k(T.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Cn.si);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        $r("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(n, r, i, o) {
        var s = this;
        if (void 0 === i && (i = new Or), void 0 === o && (o = new Ur), this.Vl = i, this.yl = o, 
        this.pl = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.gl = new Un, this.INTERNAL = {
            delete: function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
            ...
            var u = n;
            this.pl = u, this.Nc = t.Sl(u), this.Cl = u.name, this.Dl = new tr(r);
        } else {
            var a = n;
            if (!a.projectId) throw new k(T.INVALID_ARGUMENT, "Must provide projectId");
            this.Nc = new _(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Cl = "[DEFAULT]", this.Dl = new Xn;
        }
        this.Fl = new zi({});
    }
    return Object.defineProperty(t.prototype, "Nl", {
        get: function() {
            ...
            this.$l = new Ai(this.Nc, this.Fl.ignoreUndefinedProperties)), this.$l;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        xr("Firestore.settings", arguments, 1), Br("Firestore.settings", "object", 1, t);
        var e = new zi(t);
        if (this.bl && !this.Fl.isEqual(e)) throw new k(T.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.bl) throw new k(T.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var t, n = this;
            return e.__generator(this, (function(r) {
                if (void 0 !== this.bl && !this.bl.fl) throw new k(T.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new Ln, [ 2 /*return*/ , (this.gl.Ls((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Vl.clearPersistence(this.Nc, this.Cl) ];
        ...
        if (this.vl(), qr(t)) return this.bl.Fa(t);
        Br("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return this.bl.Fa(e);
        ...
        return new b(this.Nc, this.Cl, this.Fl.host, this.Fl.ssl, this.Fl.forceLongPolling);
    }, t.prototype.Ol = function(t, e, n) {
        var r = this.Ml();
        return this.bl = new Fi(this.Dl, this.gl), this.bl.start(r, t, e, n);
    }, t.Sl = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new k(T.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.pl) throw new k(T.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.pl;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return xr("Firestore.collection", arguments, 1), Br("Firestore.collection", "non-empty string", 1, t), 
        this.vl(), new so(V.$(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return xr("Firestore.doc", arguments, 1), Br("Firestore.doc", "non-empty string", 1, t), 
        this.vl(), Yi.ql(V.$(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (xr("Firestore.collectionGroup", arguments, 1), Br("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.vl(), new io(function(t) {
            return new Ye(V.k(), t);
        }(t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return xr("Firestore.runTransaction", arguments, 1), Br("Firestore.runTransaction", "function", 1, t), 
        this.vl().transaction((function(n) {
            return t(new Wi(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.vl(), new Qi(this);
        ...
        var e;
        xr("Firestore.setLogLevel", arguments, 1), Qr("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, u.setLogLevel(e);
    }, 
    ...
    return t.prototype.get = function(t) {
        var e = this;
        xr("Transaction.get", arguments, 1);
        var n = ho("Transaction.get", t, this.Bl);
        return this.Wl.Hc([ n.$c ]).then((function(t) {
            if (!t || 1 !== t.length) return p();
            var r = t[0];
            if (r instanceof $e) return new Ji(e.Bl, n.$c, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.kc);
            if (r instanceof ze) return new Ji(e.Bl, n.$c, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.kc);
            throw p();
        }));
        ...
        var r = ho("Transaction.set", t, this.Bl);
        n = uo("Transaction.set", n);
        var i = lo(r.kc, e, n), o = Ti(this.Bl.Nl, "Transaction.set", r.$c, i, null !== r.kc, n);
        return this.Wl.set(r.$c, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof ui ? (Fr("Transaction.update", arguments, 3), 
        r = ho("Transaction.update", t, this.Bl), i = Ri(this.Bl.Nl, "Transaction.update", r.$c, e, n, o)) : (xr("Transaction.update", arguments, 2), 
        r = ho("Transaction.update", t, this.Bl), i = ki(this.Bl.Nl, "Transaction.update", r.$c, e)), 
        this.Wl.update(r.$c, i), this;
    }, t.prototype.delete = function(t) {
        xr("Transaction.delete", arguments, 1);
        var e = ho("Transaction.delete", t, this.Bl);
    ...
    return t.prototype.set = function(t, e, n) {
        jr("WriteBatch.set", arguments, 2, 3), this.Gl();
        var r = ho("WriteBatch.set", t, this.Bl);
        n = uo("WriteBatch.set", n);
        var i = lo(r.kc, e, n), o = Ti(this.Bl.Nl, "WriteBatch.set", r.$c, i, null !== r.kc, n);
        return this.Ql = this.Ql.concat(o.Oc(r.$c, Ne.Ge())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Gl(), "string" == typeof e || e instanceof ui ? (Fr("WriteBatch.update", arguments, 3), 
        r = ho("WriteBatch.update", t, this.Bl), i = Ri(this.Bl.Nl, "WriteBatch.update", r.$c, e, n, o)) : (xr("WriteBatch.update", arguments, 2), 
        r = ho("WriteBatch.update", t, this.Bl), i = ki(this.Bl.Nl, "WriteBatch.update", r.$c, e)), 
        this.Ql = this.Ql.concat(i.Oc(r.$c, Ne.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        xr("WriteBatch.delete", arguments, 1), this.Gl();
        var e = ho("WriteBatch.delete", t, this.Bl);
        return this.Ql = this.Ql.concat(new Me(e.$c, Ne.Ge())), this;
    }, t.prototype.commit = function() {
        return this.Gl(), this.jl = !0, this.Ql.length > 0 ? this.Bl.vl().write(this.Ql) : Promise.resolve();
    }, t.prototype.Gl = function() {
        if (this.jl) throw new k(T.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Yi = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this, n.Nc, e, r) || this).$c = e, i.firestore = n, i.kc = r, 
        i.bl = i.firestore.vl(), i;
    }
    return e.__extends(n, t), n.ql = function(t, e, r) {
        ...
        get: function() {
            return new so(this.$c.path.g(), this.firestore, this.kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (xr("DocumentReference.collection", arguments, 1), Br("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new k(T.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = V.$(t);
        return new so(this.$c.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw Xr("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.$c.isEqual(t.$c) && this.kc === t.kc;
    }, n.prototype.set = function(t, e) {
        jr("DocumentReference.set", arguments, 1, 2), e = uo("DocumentReference.set", e);
        var n = lo(this.kc, t, e), r = Ti(this.firestore.Nl, "DocumentReference.set", this.$c, n, null !== this.kc, e);
        return this.bl.write(r.Oc(this.$c, Ne.Ge()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof ui ? (Fr("DocumentReference.update", arguments, 2), 
        n = Ri(this.firestore.Nl, "DocumentReference.update", this.$c, t, e, r)) : (xr("DocumentReference.update", arguments, 1), 
        n = ki(this.firestore.Nl, "DocumentReference.update", this.$c, t)), this.bl.write(n.Oc(this.$c, Ne.exists(!0)));
    }, n.prototype.delete = function() {
        return xr("DocumentReference.delete", arguments, 0), this.bl.write([ new Me(this.$c, Ne.Ge()) ]);
        ...
        "object" != typeof i[u] || qr(i[u]) || (Zr("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        $r("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++);
        var a = {
        ...
        } else Br("DocumentReference.onSnapshot", "function", u, i[u]), Gr("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        Gr("DocumentReference.onSnapshot", "function", u + 2, i[u + 2]);
        var h = {
            next: function(t) {
                i[u] && i[u](r.Kl(t));
            },
        ...
        return this.bl.listen(He(this.$c.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        jr("DocumentReference.get", arguments, 0, 1), co("DocumentReference.get", t);
        var n = this.firestore.vl();
        return t && "cache" === t.source ? n.ul(this.$c).then((function(t) {
            return new Ji(e.firestore, e.$c, t, 
            /*fromCache=*/ !0, t instanceof ze && t.Ke, e.kc);
    ...
    n.prototype.Kl = function(t) {
        ...
        return new Ji(this.firestore, this.$c, e, t.fromCache, t.hasPendingWrites, this.kc);
    }, n;
}(bi), Hi = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (jr("DocumentSnapshot.data", arguments, 0, 1), t = ao("DocumentSnapshot.data", t), 
        this.zl) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.kc) {
                var n = new Ki(this.Bl, this.$c, this.zl, this.Hl, this.Yl, 
                /* converter= */ null);
                return this.kc.fromFirestore(n, t);
            }
            return new Bi(this.Bl.Nc, this.Bl.Ul(), t.serverTimestamps || "none", (function(t) {
                return new Yi(t, e.Bl, /* converter= */ null);
            })).ml(this.zl.tn());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (jr("DocumentSnapshot.get", arguments, 1, 2), e = ao("DocumentSnapshot.get", e), 
        this.zl) {
            var r = this.zl.data().field(Oi("DocumentSnapshot.get", t, this.$c));
            if (null !== r) return new Bi(this.Bl.Nc, this.Bl.Ul(), e.serverTimestamps || "none", (function(t) {
                return new Yi(t, n.Bl, n.kc);
            })).ml(r);
        }
        ...
        get: function() {
            return new Yi(this.$c, this.Bl, this.kc);
        },
        enumerable: !1,
        configurable: !0
...
function Zi(t, e, n, r, i, o, s) {
    ...
    } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || eo(s, o), 
    u = Di(n, e, s, 
...
function to(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!Je(e) && -1 !== n.indexOf("/")) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(V.$(n));
        if (!O.j(r)) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Ot(t, new O(r));
    }
    if (n instanceof bi) return Ot(t, n.$c);
    throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Jr(n) + ".");
}
...
function ro(t) {
    if (t.un() && 0 === t.en.length) throw new k(T.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var io = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i;
        xr("Query.where", arguments, 3), Kr("Query.where", 3, r), i = "not-in" === n || "!=" === n ? n : Qr("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n);
        var o = Oi("Query.where", e), s = Zi(this.Jl, "Query.where", this.firestore.Nl, this.firestore.Nc, o, i, r);
        return new t(function(t, e) {
            var n = t.filters.concat([ e ]);
            return new Ye(t.path, t.collectionGroup, t.en.slice(), n, t.limit, t.nn, t.startAt, t.endAt);
        }(this.Jl, s), this.firestore, this.kc);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (jr("Query.orderBy", arguments, 1, 2), Gr("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = Oi("Query.orderBy", e), o = Xi(this.Jl, i, r);
        return new t(function(t, e) {
            // TODO(dimond): validate that orderBy does not list the same key twice.
            var n = t.en.concat([ e ]);
            return new Ye(t.path, t.collectionGroup, n, t.filters.slice(), t.limit, t.nn, t.startAt, t.endAt);
        }(this.Jl, o), this.firestore, this.kc);
    }, t.prototype.limit = function(e) {
        return xr("Query.limit", arguments, 1), Br("Query.limit", "number", 1, e), ti("Query.limit", 1, e), 
        new t(Xe(this.Jl, e, "F" /* First */), this.firestore, this.kc);
    }, t.prototype.limitToLast = function(e) {
        return xr("Query.limitToLast", arguments, 1), Br("Query.limitToLast", "number", 1, e), 
        ti("Query.limitToLast", 1, e), new t(Xe(this.Jl, e, "L" /* Last */), this.firestore, this.kc);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Fr("Query.startAt", arguments, 1);
        var i = this.Xl("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(tn(this.Jl, i), this.firestore, this.kc);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Fr("Query.startAfter", arguments, 1);
        var i = this.Xl("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(tn(this.Jl, i), this.firestore, this.kc);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Fr("Query.endBefore", arguments, 1);
        var i = this.Xl("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(en(this.Jl, i), this.firestore, this.kc);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Fr("Query.endAt", arguments, 1);
        var i = this.Xl("Query.endAt", e, n, 
        /*before=*/ !1);
        return new t(en(this.Jl, i), this.firestore, this.kc);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Xr("isEqual", "Query", 1, e);
        return this.firestore === e.firestore && nn(this.Jl, e.Jl) && this.kc === e.kc;
    }, t.prototype.withConverter = function(e) {
        return new t(this.Jl, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.Xl = function(t, n, r, i) {
        if (Kr(t, 1, n), n instanceof Ji) return xr(t, e.__spreadArrays([ n ], r), 1), function(t, e, n, r, i) {
            ...
            // results.
            for (var o = [], s = 0, u = Ke(t); s < u.length; s++) {
                var a = u[s];
                if (a.field.L()) o.push(Ot(e, r.key)); else {
            ...
            return new gn(o, i);
        }(this.Jl, this.firestore.Nc, t, n.zl, i);
        var o = [ n ].concat(r);
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.L()) {
                    ...
                    if (!Je(t) && -1 !== c.indexOf("/")) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(V.$(c));
                    if (!O.j(h)) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new O(h);
                    u.push(Ot(e, f));
                } else {
                    var l = Di(n, r, c);
        ...
        var s = {}, u = 0;
        if ("object" != typeof i[u] || qr(i[u]) || (Zr("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        $r("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++), qr(i[u])) {
            var a = i[u];
        ...
        } else Br("Query.onSnapshot", "function", u, i[u]), Gr("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        Gr("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new oo(r.firestore, r.Jl, t, r.kc));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return ro(this.Jl), this.firestore.vl().listen(this.Jl, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        jr("Query.get", arguments, 0, 1), co("Query.get", t), ro(this.Jl);
        var n = this.firestore.vl();
        return (t && "cache" === t.source ? n.ll(this.Jl) : n._l(this.Jl, t)).then((function(t) {
            return new oo(e.firestore, e.Jl, t, e.kc);
        }));
    }, t;
}(), oo = /** @class */ function() {
    function t(t, e, n, r) {
        this.Bl = t, this.Zl = e, this.t_ = n, this.kc = r, this.e_ = null, this.n_ = null, 
        this.metadata = new Hi(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        jr("QuerySnapshot.forEach", arguments, 1, 2), Br("QuerySnapshot.forEach", "function", 1, t), 
        this.t_.docs.forEach((function(r) {
            t.call(e, n.s_(r, n.metadata.fromCache, n.t_.qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new io(this.Zl, this.Bl, this.kc);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (Zr("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), $r("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.t_.Bt) throw new k(T.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.Bl === e.Bl && nn(this.Zl, e.Zl) && this.t_.isEqual(e.t_) && this.kc === e.kc;
    }, t.prototype.s_ = function(t, e, n) {
        return new Ki(this.Bl, t.key, t, e, n, this.kc);
    }, t;
}(), so = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        if ((i = t.call(this, He(e), n, r) || this).i_ = e, e.length % 2 != 1) throw new k(T.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + e.N() + " has " + e.length);
        return i;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new Yi(new O(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = g.t()), Br("CollectionReference.doc", "non-empty string", 1, t);
        var e = V.$(t);
        return Yi.ql(this.Jl.path.child(e), this.firestore, this.kc);
    }, n.prototype.add = function(t) {
        xr("CollectionReference.add", arguments, 1), Br("CollectionReference.add", "object", 1, this.kc ? this.kc.toFirestore(t) : t);
        var e = this.doc();
...
function uo(t, e) {
    ...
    if (Zr(t, e, [ "merge", "mergeFields" ]), $r(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + Jr(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + Jr(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof ui;
...
function ao(t, e) {
    return void 0 === e ? {} : (Zr(t, e, [ "serverTimestamps" ]), Wr(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function co(t, e) {
    Gr(t, "object", 1, e), e && (Zr(t, e, [ "source" ]), Wr(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var po = {
    ...
    Transaction: Wi,
    WriteBatch: Qi,
    DocumentReference: Yi,
    DocumentSnapshot: Ji,
    Query: io,
    QueryDocumentSnapshot: Ki,
    QuerySnapshot: oo,
 ...
 */ function yo(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new s.Component("firestore", (function(t) {
            return function(t, e) {
                return new $i(t, e, new Or, new Ur);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, po)));
