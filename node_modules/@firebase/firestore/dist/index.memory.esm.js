...
function E(t) {
    ...
    if (w.logLevel <= s.DEBUG) {
        var i = e.map(A);
        w.debug.apply(w, r([ "Firestore (7.19.0): " + t ], i));
    }
}
...
function I(t) {
    ...
    if (w.logLevel <= s.ERROR) {
        var i = e.map(A);
        w.error.apply(w, r([ "Firestore (7.19.0): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (w.logLevel <= s.WARN) {
        var i = e.map(A);
        w.warn.apply(w, r([ "Firestore (7.19.0): " + t ], i));
    }
}
...
}(G), z = /^[_a-zA-Z][_a-zA-Z0-9]*$/, $ = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.V = function(t, e, r) {
...
function K(t) {
    ...
    if (null === e.K) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            ...
            var e;
        })).join(","), W(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
...
function X(t) {
    return Q.j(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.$e = function(t) {
        ...
        return this.Re = pt(), this.Ae = Lt(), this.Pe = new ht(V), i;
    }, 
    /**
    ...
    t.prototype.we = function(t) {
        ...
        var e = this.Ae.get(t);
        return e || (e = new ht(V), this.Ae = this.Ae.st(t, e)), e;
    }, 
    /**
...
/** Extracts the backend's type order for the provided value. */ function Ct(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Ot(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : T();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Mt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return S(t.arrayValue.values || [], e.arrayValue.values || [], Mt);
...
function he(t, e) {
    ...
    return k(r.get(1) === t.s.projectId), k(!r.get(3) && !t.s.database || r.get(3) === t.s.database), 
    new Q((k((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
 ...
 */ var Pe = /** @class */ function() {
    ...
    return t.prototype.je = function(t) {
        ...
        return S(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), Oe = function(t, e) {
 ...
 */ function Fe(t, e, n) {
    return t instanceof ze ? function(t, e, n) {
        ...
        if (k(null != n.transformResults), !Ce(t.We, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
...
function Ge(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.We.isEqual(e.We) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || S(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof ke && e instanceof ke || t instanceof De && e instanceof De ? S(t.elements, e.elements, Mt) : t instanceof Ve && e instanceof Ve ? Mt(t.Ue, e.Ue) : t instanceof Te && e instanceof Te;
 ...
 */ function fn(t) {
    var e = sn(t, un);
    if (!e.rn) if ("F" /* First */ === e.nn) e.rn = J(e.path, e.collectionGroup, hn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
...
function gn(t) {
    return "Query(target=" + function(t) {
        ...
        W(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.N() + " (" + e.dir + ")";
            var e;
...
/** Returns whether `doc` matches the constraints of `query`. */ function mn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.W(t.collectionGroup) && t.path.C(n) : Q.j(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
...
var bn = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        if (Ht(r)) {
            ...
            throw new F(M.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (Jt(r)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new F(M.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
 ...
 */ function Sn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.L() ? Q.P(Q.B(s.referenceValue), n.key) : xt(s, n.field(o.field)), 
...
function On(t, e, n) {
    var r = t.field.L() ? Q.P(e.key, n.key) : function(t, e, n) {
 ...
 */ var qn = /** @class */ function() {
    ...
    t.prototype.Rn = function(t) {
        ...
        return this.batchId === t.batchId && S(this.mutations, t.mutations, (function(t, e) {
            return Ge(t, e);
        })) && S(this.baseMutations, t.baseMutations, (function(t, e) {
            return Ge(t, e);
        }));
    }, t;
}(), Cn = /** @class */ function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.gn && T(), this.gn = !0, this.pn ? this.error ? this.vn(n, this.error) : this.bn(e, this.result) : new t((function(t, i) {
            r.Vn = function(n) {
                r.bn(e, n).next(t, i);
            }, r.yn = function(e) {
                r.vn(n, e).next(t, i);
 ...
 */
        ...
        return this.On(t, new Q(e)).next((function(t) {
            var e = vt();
...
var Gn = function() {
    ...
    t.prototype.ws = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && E("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.ls + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
 ...
 */ var Qn = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.ps && (this.clearTimeout(), this.Vs.reject(new F(M.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Os = function() {
            var e = $n();
            e && E("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.ks.Es();
        };
        var e = $n();
    ...
    t.prototype.Ws = function() {
        ...
        var e = this, n = this.bs.then((function() {
            return e.Ns = !0, t().catch((function(t) {
                ...
                throw e.Fs = t, e.Ns = !1, I("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
function Yn(t, e) {
    if (I("AsyncQueue", e + ": " + t), zn(t)) return new F(M.UNAVAILABLE, e + ": " + t);
    throw t;
}
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                s = s.next((function() {
                    ...
                    k(null !== s), (!o || o.version.o(s) < 0) && ((o = i.Tn(t, o, n)) && 
 ...
 */ function nr(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return k(e.resumeToken.Y() > 0), 0 === t.resumeToken.Y() || (
...
function ir(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = R(t), o = e.fi.get(r), s = i ? "readwrite" : "readwrite-primary", n.label = 1;
 ...
 */ var ur = /** @class */ function() {
    ...
    t.prototype.Zi = function(t) {
        var e = this, n = new Q(new B([])), r = new ar(n, t), i = new ar(n, t + 1), o = [];
        ...
        var e = new Q(new B([])), n = new ar(e, t), r = new ar(e, t + 1), i = wt();
    ...
    return t.ji = function(t, e) {
        return Q.P(t.key, e.key) || V(t.sr, e.sr);
    }, 
    /** Compare by ID then by key */ t.Ki = function(t, e) {
        return V(t.sr, e.sr) || Q.P(t.key, e.key);
    }, t;
}(), cr = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
var hr = function(t, e) {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (k("string" == typeof n.accessToken), new hr(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.Tr = function() {
        ...
        return k(null === t || "string" == typeof t), new cr(t);
    }, t;
}(), pr = /** @class */ function() {
    function t(t, e) {
    ...
    t.prototype.Or = function(t) {
        ...
        return function(n) {
            e.os.vs((function() {
                return e.yr === t ? n() : (E("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.Mr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Me ? (k(void 0 === e || "string" == typeof e), tt.fromBase64String(e || "")) : (k(void 0 === e || e instanceof Uint8Array), 
    ...
    return t(n, e), Object.defineProperty(n.prototype, "Gr", {
        /**
    ...
    n.prototype.start = function() {
        ...
        k(!!t.streamToken), this.lastStreamToken = t.streamToken, this.jr) {
        ...
        // The first response is always the handshake response
                return k(!t.writeResults || 0 === t.writeResults.length), this.jr = !0, 
        this.listener.Hr();
    }, 
    /**
    ...
    return t(n, e), n.prototype.Xr = function() {
        if (this.Jr) throw new F(M.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Zr = function(t, e, n) {
        ...
        return this.Xr(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === M.UNAUTHENTICATED && r.credentials.cr(), t;
        }));
    }, 
            ...
            i.vs((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Eo() ? (E("RemoteStore", "Restarting streams for network reachability change."), 
    ...
    t.prototype.disableNetwork = function() {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this._o.length > 0 && (E("RemoteStore", "Stopping write stream with " + this._o.length + " pending writes"), 
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return E("RemoteStore", "RemoteStore shutting down."), this.wo.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.$o() ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 11:
                    return E("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.Bo(o) ];
    ...
    t.prototype.zo = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return ot(r = t.code) && r !== M.ABORTED ? (e = this._o.shift(), 
...
n) {
    ...
    r, i, o) {
        ...
        this.Bh = null, this.Wh = new C((function(t) {
            return vn(t);
        }), yn), this.Qh = new Map, 
        /**
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    ...
                    function(t, e) {
                        var n, r = R(t), i = x.now(), o = e.reduce((function(t, e) {
                            return t.add(e.key);
                        }), wt());
                ...
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    t.Qt.forEach((function(t, e) {
                        ...
                        k(t.Jt.size + t.Xt.size + t.Zt.size <= 1), t.Jt.size > 0 ? n.Lh = !0 : t.Xt.size > 0 ? k(n.Lh) : t.Zt.size > 0 && (k(n.Lh), 
                        n.Lh = !1));
                    })), [ 4 /*yield*/ , this.ua(e, t) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.qh._h(t, "rejected", r), e = this.Kh.get(t), (i = e && e.key) ? (o = (o = new ut(Q.P)).st(i, new rn(i, j.min())), 
                    s = wt().add(i), u = new Tt(j.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new ht(V), o, s), [ 4 /*yield*/ , this.jo(u) ]) : [ 3 /*break*/ , 2 ];
                    ...
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                        ...
                        return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                            ...
                            return n.$n.da(t, e).next((function(e) {
                                return k(null !== e), r = e.keys(), n.$n.Si(t, e);
                            })).next((function() {
                                return n.$n.Ci(t);
                            })).next((function() {
                                return n.Ai.Un(t, r);
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Ta = function(t) {
        ...
        n || (n = new ut(V)), n = n.st(t, e), this.Hh[this.currentUser.rr()] = n;
    }, 
    /**
    ...
    t.prototype._a = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Nr ? (this.zh.zi(i.key, t), this.Ra(i)) : i instanceof Ar ? (E("SyncEngine", "Document no longer in limbo: " + i.key), 
    ...
    t.prototype.Pa = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (E("SyncEngine", "User change. New user:", t.rr()), 
                    [ 4 /*yield*/ , 
                    /**
                    ...
                    function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = R(t), i = e.$n, o = e.Ai, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
    ...
    function t(t) {
        this.qo = t, this.ba = new C((function(t) {
            return vn(t);
    ...
    return t.prototype.Vi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var u = i.Wa(e, o);
            return (e.an() || e.un()) && i.Sh(e.nn, u, r, n) ? i.Ba(t, e) : (b() <= s.DEBUG && E("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), gn(e)), 
    ...
    return t.prototype.Ga = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                Q.j(i) || (i = i.child(""));
        var o = new ar(new Q(i), 0), s = new ht(V);
        ...
        var n = this;
        k(0 === this.Ya(e.batchId, "removed")), this.$n.shift();
        var r = this.ja;
    ...
    t.prototype.Oi = function(t) {
        ...
        for (var r = vt(), i = new Q(e.path.child("")), o = this.docs.ct(i)
...
Or.nu = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.Ch = function(t) {
        var e = this, n = [];
...
var Ur = /** @class */ function() {
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.Ju = function(t, e, n, r) {
        ...
        var n = [ this.Ku, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = v(), i = {
        ...
        return m(g.EventType.OPEN, (function() {
            ...
            d || (d = !0, E("Connection", "WebChannel transport closed"), y.Qu());
        })), m(g.EventType.ERROR, (function(t) {
            d || (d = !0, N("Connection", "WebChannel transport errored:", t), y.Qu(new F(M.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    d = !0, y.Qu(new F(u, a)), s.close();
                } else E("Connection", "WebChannel received:", n), y.ju(n);
            }
        })), setTimeout((function() {
 ...
 */ var $r = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Qr = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t._c.lc) throw new F(M.FAILED_PRECONDITION, $r);
        return new qr(Mr.ku);
        ...
        throw new F(M.FAILED_PRECONDITION, $r);
    }, t;
}(), Wr = /** @class */ function() {
    function t() {}
 ...
 */ function Jr(t, e) {
    if (0 !== e.length) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + di(e.length, "argument") + ".");
}
 ...
 */ function Kr(t, e, n) {
    if (e.length !== n) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires " + di(n, "argument") + ", but was called with " + di(e.length, "argument") + ".");
}
 ...
 */ function Zr(t, e, n) {
    if (e.length < n) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires at least " + di(n, "argument") + ", but was called with " + di(e.length, "argument") + ".");
}
 ...
 */ function Xr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + di(e.length, "argument") + ".");
}
 ...
 */ function oi(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new F(M.INVALID_ARGUMENT, "Invalid value " + ai(r) + " provided to function " + t + "() for its " + pi(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
function ci(t, e, n) {
    if (void 0 === n) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + pi(e) + " argument, but it was undefined.");
}
 ...
 */ function fi(t, e, n, r) {
    var i = ai(r);
    return new F(M.INVALID_ARGUMENT, "Function " + t + "() requires its " + pi(n) + " argument to be a " + e + ", but it was: " + i);
}

function li(t, e, n) {
    if (n <= 0) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires its " + pi(e) + " argument to be a positive number, but it was: " + n + ".");
}
 ...
 */ var gi = /** @class */ function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new F(M.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + di(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (ti("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new F(M.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Ac = new $(t);
}, wi = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.prototype.yc = function(t) {
...
function zi(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x || t instanceof Vi || t instanceof gi || t instanceof Li || t instanceof Ei);
}
 ...
 */ function Wi(t, e, n) {
    try {
        return function(t) {
            if (t.search(bi) >= 0) throw new F(M.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
 ...
 */ var Ji = /** @class */ function() {
    ...
    return t.prototype.Hc = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.Yc(), this.mutations.length > 0) throw new F(M.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof rn || t instanceof nn ? i.Jc(t) : T();
                    })), r) ];
                }
            }));
        }));
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.lr((function(t) {
            if (!s) return s = !0, E("FirestoreClient", "Initializing. user=", t.uid), i.ol(e, n, r, t, o).then(i.il.resolve, i.il.reject);
            i.Rs.Bs((function() {
                return i.Mh.eh(t);
            }));
        })), 
    ...
    t.prototype.rl = function() {
        if (this.Rs.xs) throw new F(M.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
...
var to = /** @class */ function() {
    ...
    return t.prototype.ml = function(t) {
        ...
        var e = B.$(t);
        k(be(e));
        var n = new P(e.get(1), e.get(3)), r = new Q(e.p(5));
    ...
    function t(t) {
        ...
        ri("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Hn.ii; else {
            if (t.cacheSizeBytes !== eo && t.cacheSizeBytes < Hn.si) throw new F(M.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Hn.si);
    ...
    function t(r, i, o, s) {
        ...
        this.gl = new Wn, this.INTERNAL = {
            ...
            this.Nc = new P(c.projectId, c.database), 
    ...
    return Object.defineProperty(t.prototype, "Nl", {
        ...
        var e = new no(t);
        if (this.bl && !this.Fl.isEqual(e)) throw new F(M.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.bl) throw new F(M.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.bl && !this.bl.fl) throw new F(M.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        ...
        return new L(this.Nc, this.Cl, this.Fl.host, this.Fl.ssl, this.Fl.forceLongPolling);
 ...
 */        if (!n || "string" != typeof n) throw new F(M.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.pl) throw new F(M.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.pl;
        },
        enumerable: !1,
        configurable: !0
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.jl) throw new F(M.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), so = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.ql = function(t, e, r) {
...
function ho(t, e, n, r, i, o, s) {
    ...
    return function(t, e) {
        if (e._n()) {
            var n = t.ln();
            if (null !== n && !n.isEqual(e.field)) throw new F(M.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
            var r = t.cn();
 ...
 */
        ...
        throw i === e.op ? new F(M.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new F(M.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
    }(t, l), l;
}
...
function lo(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!Q.j(r)) throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Qt(t, new Q(r));
    }
    if (n instanceof Li) return Qt(t, n.$c);
    throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ai(n) + ".");
}
...
function vo(t) {
    if (t.un() && 0 === t.en.length) throw new F(M.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var go = /** @class */ function() {
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.Xl = function(t, e, n, i) {
        if (ci(t, 1, e), e instanceof ao) return Kr(t, r([ e ], n), 1), function(t, e, n, r, i) {
            ...
            for (var o = [], s = 0, u = hn(t); s < u.length; s++) {
                ...
                if (a.field.L()) o.push(Qt(e, r.key)); else {
                    ...
                    if (Ot(c)) throw new F(M.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.N();
        ...
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.L()) {
                    ...
                    if (!Q.j(h)) throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new Q(h);
                    u.push(Qt(e, f));
                } else {
                    var l = ji(n, r, c);
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.t_.Bt) throw new F(M.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, an(t), n, r) || this).i_ = t, t.length % 2 != 1) throw new F(M.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.N() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new so(new Q(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
...
function bo(t, e) {
    ...
    if (hi(t, e, [ "merge", "mergeFields" ]), ri(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + ai(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + ai(r[o]));
        }(t, e, n, r, i);
