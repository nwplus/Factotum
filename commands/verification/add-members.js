    ...
    registry.registerChatInputCommand((builder) =>
      builder
        ...
        .addStringOption((option) =>
          option
            .setName("participantstype")
            .setDescription(
              "Type of role of the added participants (i.e. hacker, sponsor)",
            )
            .setRequired(true),
        )
  ...
  async chatInputRun(interaction) {
    ...
    if (!roleExists) {
      await interaction.reply({
        content: "The role you entered does not exist!",
        ephemeral: true,
      });
      return;
    }
    ...
    if (submitted) {
      ...
      submitted.reply({
        content:
          emails.length + " emails have been added as " + participantsType,
        ephemeral: true,
      });
    }
  }
