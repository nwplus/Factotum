...
module.exports = class StartAttend extends PermissionCommand {
    ...
    async runCommand(message, { existsChannel }) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setTitle('Hey there!')
            .setDescription('<@&' + discordServices.hackerRole + '> In order to indicate that you are participating at nwHacks 2021, please send the **!attend** command to this channel followed by the email you used to sign up. \nFor example: !attend example@gmail.com')
